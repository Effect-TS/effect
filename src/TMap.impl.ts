...
export const removeIf: {
  <K, V>(predicate: (key: K, value: V) => boolean): (self: TMap<K, V>) => STM<never, never, Array<readonly [K, V]>>
  <K, V>(self: TMap<K, V>, predicate: (key: K, value: V) => boolean): STM<never, never, Array<readonly [K, V]>>
} = internal.removeIf
 ...
 */
export const toChunk: <K, V>(self: TMap<K, V>) => STM<never, never, Array<readonly [K, V]>> = internal.toArray
 ...
 * @category destructors
 */
export const toReadonlyArray: <K, V>(self: TMap<K, V>) => STM<never, never, ReadonlyArray<readonly [K, V]>> =
