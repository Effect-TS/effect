 ...
 */
export const make: <A>(value: A) => Effect<never, never, SynchronizedRef<A>> = circular.makeSynchronized

/**
 * @since 2.0.0
 * @category getters
 */
export const get: <A>(self: SynchronizedRef<A>) => Effect<never, never, A> = ref.get
