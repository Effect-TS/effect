import type { ChildExecutorDecisionTypeId, Close, Continue, Yield } from "../ChildExecutorDecision.js"

export * from "../ChildExecutorDecision.js"
...
export declare namespace ChildExecutorDecision {
  ...
  // @ts-expect-error
  export type * from "../ChildExecutorDecision.js"
}
