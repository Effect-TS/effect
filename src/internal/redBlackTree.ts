...
/** @internal */
export const fromIterable = <K, V>(ord: Order<K>) => (entries: Iterable<readonly [K, V]>): RBT<K, V> => {
...
export const atBackwards = dual<
  (index: number) => <K, V>(self: RBT<K, V>) => Iterable<readonly [K, V]>,
  <K, V>(self: RBT<K, V>, index: number) => Iterable<readonly [K, V]>
...
/** @internal */
export const first = <K, V>(self: RBT<K, V>): Option<readonly [K, V]> => {
...
export const getAt = dual<
  (index: number) => <K, V>(self: RBT<K, V>) => Option<readonly [K, V]>,
  <K, V>(self: RBT<K, V>, index: number) => Option<readonly [K, V]>
...
/** @internal */
export const last = <K, V>(self: RBT<K, V>): Option<readonly [K, V]> => {
  let node: Node.Node<K, V> | undefined = (self as RedBlackTreeImpl<K, V>)._root
  let current: Node.Node<K, V> | undefined = (self as RedBlackTreeImpl<K, V>)._root
  while (node !== undefined) {
    current = node
...
/** @internal */
export const reversed = <K, V>(self: RBT<K, V>): Iterable<readonly [K, V]> => {
  return {
    [Symbol.iterator]: () => {
      const stack: Array<Node.Node<K, V>> = []
      let node = (self as RedBlackTreeImpl<K, V>)._root
...
export const greaterThanBackwards = dual<
  <K>(key: K) => <V>(self: RBT<K, V>) => Iterable<readonly [K, V]>,
  <K, V>(self: RBT<K, V>, key: K) => Iterable<readonly [K, V]>
