...
/** @internal */
export const fromEffect = <R, E, A>(effect: Effect<R, E, A>): Effect<R, never, Take.Take<E, A>> =>
...
export const matchEffect = dual<
  ...
  ) => (self: Take.Take<E, A>) => Effect<R | R2 | R3, E2 | E | E3, Z | Z2 | Z3>,
  <R, E2, Z, R2, E, Z2, A, R3, E3, Z3>(
    self: Take.Take<E, A>,
    options: {
      readonly onEnd: () => Effect<R, E2, Z>
...
export const tap = dual<
  ...
  ) => <E>(self: Take.Take<E, A>) => Effect<R, E2 | E, void>,
  <E, A, R, E2, _>(
    self: Take.Take<E, A>,
    f: (chunk: Chunk.Chunk<A>) => Effect<R, E2, _>
  ) => Effect<R, E2 | E, void>
