...
See the [original Effect-TS README](https://github.com/Effect-TS/effect/blob/main/README.md) for more info about Effect itself.
...
|![](https://img.shields.io/npm/v/@effect-native/patterns)|@effect-native/patterns|ignore this for now|
