...
/**
 * @tsplus type ets/MetricState/Ops
 */
...
/**
 * @tsplus static ets/MetricState/Ops Counter
 */
...
/**
 * @tsplus static ets/MetricState/Ops Gauge
 */
...
/**
 * @tsplus static ets/MetricState/Ops Histogram
 */
...
/**
 * @tsplus static ets/MetricState/Ops Summary
 */
...
/**
 * @tsplus static ets/MetricState/Ops SetCount
 */
...
function resolveQuantiles(
  ...
  if (restAndConsumed > desired + allowedError) {
    return Eval.succeed(new ResolvedQuantile(quantile, current, consumed, rest));
  }
