...
export interface TestConsole {
   ...
   */
  readonly print: (line: any) => Effect<never, TestConsoleError, void>
  /**
   * Writes the specified string to the error buffer.
   */
  readonly printError: (line: any) => Effect<never, TestConsoleError, void>
  /**
   * Writes the specified string to the output buffer followed by a newline
   * character.
   */
  readonly printLine: (line: any) => Effect<never, TestConsoleError, void>
  /**
   ...
   */
  readonly readLine: () => Effect<never, TestConsoleError, void>
  /**
   ...
   */
  readonly feedLines: (lines: ImmutableArray<string>) => Effect<never, never, void>
  /**
   * Takes the first value from the input buffer, if one exists, or else fails
   * with an `EOFException`.
   */
  readonly output: () => Effect<never, never, ImmutableArray<string>>
  /**
   ...
   */
  readonly outputError: () => Effect<never, never, void>
  /**
   * Clears the contents of the input buffer.
   */
  readonly clearInput: () => Effect<never, never, void>
  /**
   * Clears the contents of the output buffer.
   */
  readonly clearOutput: () => Effect<never, never, void>
  // /**
 ...
 * with an `EOFException`.
 */
export function readLine(): Effect<TestConsole, TestConsoleError, void> {
 ...
 * with an `EOFException`.
 */
export function output(): Effect<TestConsole, never, ImmutableArray<string>> {
 ...
 * to the error output buffer will be the first in the sequence.
 */
export function outputError(): Effect<TestConsole, never, void> {
 ...
 * Clears the contents of the input buffer.
 */
export function clearInput(): Effect<TestConsole, never, void> {
 ...
 * Clears the contents of the output buffer.
 */
export function clearOutput(): Effect<TestConsole, never, void> {
