...
export function andThen_<R, E, A, E1, B>(
  ...
  return P.chain_(self, (a) => provideEnvironment_(that, a))
}
 ...
 */
export function mapBoth<R, E, A, E1, B>(
  g: (e: E) => E1,
  f: (a: A) => B
): (self: P.STM<R, E, A>) => P.STM<R, E1, B> {
  return (self) => mapBoth_(self, g, f)
}
 ...
 * continue with the returned value.
 *
 * @ets_data_first continueOrFailWithSTM_
 */
...
export function eventually<R, E, A>(self: P.STM<R, E, A>): P.STM<R, never, A> {
  return P.foldSTM_(self, () => eventually(self), P.succeedNow)
}
...
export function filterOrElse_<R, E, A, R2, E2, A2>(
  ...
  return P.chain_(
    fa,
    (a): P.STM<R2, E2, A | A2> =>
      p(a) ? P.succeedNow(a) : suspend(() => (or as (a: A) => P.STM<R2, E2, A2>)(a))
  )
}
...
export function flip<R, E, A>(self: P.STM<R, E, A>) {
  return P.foldSTM_(self, P.succeedNow, P.failNow)
}
...
export function forEach_<A, R, E, B>(
  ...
  return suspend(() => {
    let stm = P.succeedNow([]) as P.STM<R, E, B[]>
...
export function mapError_<R, E, A, E1>(
  ...
  return P.foldSTM_(self, (e) => P.failNow(f(e)), P.succeedNow)
}
...
export function provideEnvironment_<R, E, A>(
  ...
  return P.provideSomeEnvironment_(self, () => r)
}
...
export function provideEnvironment<R>(
  ...
  return (self) => provideEnvironment_(self, r)
}
...
export function repeatUntil_<R, E, A>(
  ...
  return P.chain_(self, (a) => (f(a) ? P.succeedNow(a) : repeatUntil_(self, f)))
}
...
export function repeatWhile_<R, E, A>(
  ...
  return P.chain_(self, (a) => (f(a) ? repeatWhile_(self, f) : P.succeedNow(a)))
}
