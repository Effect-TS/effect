...
export class Succeed<A> extends Base<never, unknown, never, unknown, never, A> {
...
export class Log<W> extends Base<W, unknown, never, unknown, never, never> {
  readonly _xptag = "Log"
...
export class Suspend<W, S1, S2, R, E, A> extends Base<W, S1, S2, R, E, A> {
...
export class Fail<E> extends Base<never, unknown, never, unknown, E, never> {
...
export class Modify<S1, S2, E, A> extends Base<never, S1, S2, unknown, E, A> {
...
export class FlatMap<W, W2, S1, S2, S3, R, R1, E, E1, A, B> extends Base<
  W | W2,
  S1,
  S3,
  R & R1,
...
export class Fold<W, W1, W2, S1, S2, S3, R, E1, E2, A, B> extends Base<
  W | W1 | W2,
  S1,
  S3,
  R,
...
export class Access<W, S1, S2, R, E, A> extends Base<W, S1, S2, R, E, A> {
...
export class Provide<W, S1, S2, R, E, A> extends Base<W, S1, S2, unknown, E, A> {
 ...
 * @tsplus macro remove
 */
export function concrete<W, S1, S2, R, E, A>(
