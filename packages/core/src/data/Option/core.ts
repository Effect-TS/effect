...
const _noneHash = St.hashString("@effect-ts/core/Option/None")
const _someHash = St.hashString("@effect-ts/core/Option/Some")
...
export function zip<B>(fb: Option<B>) {
  return <A>(fa: Option<A>): Option<Tuple<[A, B]>> => zip_(fa, fb)
}
...
export const PartialExceptionTypeId = Symbol(
  "@effect-ts/core/data/Option/PartialException"
)
