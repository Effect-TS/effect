...
export interface Interrupt {
  ...
  readonly errors: Option<NonEmptyArray<unknown>>
  readonly causedBy: Option<Cause<unknown>>
  next: Option<Cause<unknown>>
}
...
>(
  ...
  onRaise: (v: E, next: Option<Cause<unknown>>) => Effect<S2, R2, E2, B2>,
  onAbort: (v: unknown, next: Option<Cause<unknown>>) => Effect<S3, R3, E3, B3>,
  onInterrupt: (
    errors: Option<NonEmptyArray<unknown>>,
    next: Option<Cause<unknown>>
  ) => Effect<S4, R4, E4, B4>
...
>(
  ...
  onRaise: (v: E, next: Option<Cause<unknown>>) => Managed<S2, R2, E2, B2>,
  onAbort: (v: unknown, next: Option<Cause<unknown>>) => Managed<S3, R3, E3, B3>,
  onInterrupt: (
    errors: Option<NonEmptyArray<unknown>>,
    next: Option<Cause<unknown>>
  ) => Managed<S4, R4, E4, B4>
...
>(
  ...
  onRaise: (v: E, next: Option<Cause<unknown>>) => Stream<S2, R2, E2, B2>,
  onAbort: (v: unknown, next: Option<Cause<unknown>>) => Stream<S3, R3, E3, B3>,
  onInterrupt: (
    errors: Option<NonEmptyArray<unknown>>,
    next: Option<Cause<unknown>>
  ) => Stream<S4, R4, E4, B4>
...
>(
  ...
  onRaise: (v: E, next: Option<Cause<unknown>>) => StreamEither<S2, R2, E2, B2>,
  onAbort: (v: unknown, next: Option<Cause<unknown>>) => StreamEither<S3, R3, E3, B3>,
  onInterrupt: (
    errors: Option<NonEmptyArray<unknown>>,
    next: Option<Cause<unknown>>
...
export function fold_<E, A, B1, B2, B3, B4>(
  e: Exit<E, A>,
  onDone: (v: A) => B1,
  onRaise: (v: E, next: Option<Cause<unknown>>) => B2,
  onAbort: (v: unknown, next: Option<Cause<unknown>>) => B3,
  onInterrupt: (
    errors: Option<NonEmptyArray<unknown>>,
    next: Option<Cause<unknown>>
  ) => B4
...
export function fold_<E, A, B>(
  e: Exit<E, A>,
  onDone: (v: A) => B,
  onRaise: (v: E, next: Option<Cause<unknown>>) => B,
  onAbort: (v: unknown, next: Option<Cause<unknown>>) => B,
  onInterrupt: (
    errors: Option<NonEmptyArray<unknown>>,
    next: Option<Cause<unknown>>
  ) => B
...
export const interruptWithError = (...errors: ReadonlyArray<unknown>): Interrupt =>
  errors.length > 0
    ? {
        _tag: "Interrupt",
        errors: some(errors as NonEmptyArray<unknown>),
        next: none,
        causedBy: none
      }
    : {
