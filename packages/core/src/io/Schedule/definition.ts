...
export const _Env = Symbol.for("@effect-ts/core/io/Schedule/_Env")
export type _Env = typeof _Env

export const _In = Symbol.for("@effect-ts/core/io/Schedule/_In")
export type _In = typeof _In

export const _Out = Symbol.for("@effect-ts/core/io/Schedule/_Out")
export type _Out = typeof _Out

export const _State = Symbol.for("@effect-ts/core/io/Schedule/_State")
