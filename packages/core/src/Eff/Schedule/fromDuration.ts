...
export function fromDurations(
  ...
  ms1: number,
  ms2: number
): Schedule<unknown, Clock, Either<number, Either<number, number>>, unknown, number>
export function fromDurations(
  ms0: number,
  ms1: number
): Schedule<unknown, Clock, Either<number, number>, unknown, number>
export function fromDurations(
  ...ms: number[]
): Schedule<unknown, Clock, any, unknown, number> {
