import { boom, makeStair, makeTArray, N, n } from "@effect-ts/core/test/stm/TArray/test-utils";
      ...
      const program = Effect.Do()
        ...
        .bind("sum1Fiber", ({ tArray }) =>
          tArray
            ...
            .commit()
            .fork())
        .tap(({ tArray }) => STM.forEach(Chunk.range(0, N), (i) => tArray.update(i, (n) => n + 1)).commit())
