import { boom, largePrime, makeStairWithHoles, makeTArray, N, n } from "@effect-ts/core/test/stm/TArray/test-utils";
      ...
      const program = Effect.Do()
        ...
        .bind("findFiber", ({ tArray }) =>
          tArray
            ...
            .commit()
            .fork())
        .tap(({ tArray }) => STM.forEach(Chunk.range(0, N), (i) => tArray.update(i, () => Option.some(1))).commit())
