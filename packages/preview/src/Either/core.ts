...
import { ApplicativeKE, makeApplicative } from "../_abstract/Applicative"
...
declare module "../_abstract/HKT" {
  ...
  > {
    ...
    [ValidationURI]: E.Either<Err, Out>
  }
}
 ...
 */
export const IdentityBoth = makeIdentityBoth<EitherURI>()()(
...
export function getValidationAny<E>() {
  return makeAny<ValidationURI, E>()()({
    any: () => E.right({})
  })
}
...
export function getValidationCovariant<E>() {
  return makeCovariant<ValidationURI, E>()()({
    map: E.map
  })
}
...
export function getValidationIdentityBoth<E>(A: Associative<E>) {
  return makeIdentityBoth<ValidationURI, E>()()(
...
export function getValidationApplicative<E>(A: Associative<E>) {
  return makeApplicative<ValidationURI, E>()()(
...
export function getValidationFail<E>() {
  return makeFail<ValidationURI, E>()()({
...
export function getValidationRecover<Z>() {
  return makeRecover<ValidationURI, Z>()()({
...
export function getValidationRun<Z>() {
  return makeRun<ValidationURI, Z>()()({
    run: E.right
  })
}
...
export function getValidationAssociativeFlatten<E>() {
  return makeAssociativeFlatten<ValidationURI, E>()()({
    flatten: E.flatten
  })
}
 ...
 */
export function getValidationIdentityFlatten<E>() {
  return makeIdentityFlatten<ValidationURI, E>()()(
...
export function getValidationAssociativeBoth<E>(
  ...
  const F = intersect(
    ...
    makeAssociativeBoth<ValidationURI, E>()()({
      both: E.zip
    })
  )

  return intersect(F, validationAssociativeBothF(F, A))
}
