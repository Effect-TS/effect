...
> extends HasURI<F, TL0, TL1, TL2, TL3>, HasE<E> {
  readonly access: <R, A, In, I = In, O = In, S = In>(
    f: (r: R) => A
  ) => KindFull<F, TL0, TL1, TL2, TL3, never, never, I, O, never, In, S, R, E, A>
  readonly provide: <R>(
    r: R
  ) => <K, NK extends string, I, O, X, In, St, Err, A>(
    fa: KindFull<F, TL0, TL1, TL2, TL3, K, NK, I, O, X, In, St, R, E, A>
  ) => KindFull<F, TL0, TL1, TL2, TL3, K, NK, I, O, X, In, St, unknown, E, A>
}
