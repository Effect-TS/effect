...
describe.concurrent("Guard", () => {
  ...
  it("never", () => {
    const is = G.is(S.never)
    expect(is(1)).toEqual(false)
  })

  it("string", () => {
    const is = G.is(S.string)
    expect(is("a")).toEqual(true)
    expect(is(1)).toEqual(false)
  })

  it("number", () => {
    const is = G.is(S.number)
  ...
  it("symbol", () => {
    ...
    const is = G.is(S.symbol)
    expect(is(a)).toEqual(true)
    expect(is("@fp-ts/schema/test/a")).toEqual(false)
  })

  it("object", () => {
    const is = G.is(S.object)
    expect(is({})).toEqual(true)
    expect(is([])).toEqual(true)
    expect(is(null)).toEqual(false)
    expect(is("a")).toEqual(false)
