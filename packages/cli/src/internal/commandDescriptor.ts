...
export const getBashCompletions = <A>(
  self: Descriptor.Command<A>,
  executable: string
): Effect.Effect<ReadonlyArray<string>> => getBashCompletionsInternal(self as Instruction, executable)

/** @internal */
export const getFishCompletions = <A>(
  self: Descriptor.Command<A>,
  executable: string
): Effect.Effect<ReadonlyArray<string>> => getFishCompletionsInternal(self as Instruction, executable)

/** @internal */
export const getZshCompletions = <A>(
  self: Descriptor.Command<A>,
  executable: string
): Effect.Effect<ReadonlyArray<string>> => getZshCompletionsInternal(self as Instruction, executable)
