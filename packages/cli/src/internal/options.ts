...
export const withSchema = dual<
  <A, I extends A, B>(schema: Schema.Schema<never, I, B>) => (self: Options.Options<A>) => Options.Options<B>,
  <A, I extends A, B>(self: Options.Options<A>, schema: Schema.Schema<never, I, B>) => Options.Options<B>
>(2, (self, schema) => {
