...
export const getBashCompletions = <Name extends string, R, E, A>(
  self: Command.Command<Name, R, E, A>,
  programName: string
): Effect.Effect<ReadonlyArray<string>> => InternalDescriptor.getBashCompletions(self.descriptor, programName)

/** @internal */
export const getFishCompletions = <Name extends string, R, E, A>(
  self: Command.Command<Name, R, E, A>,
  programName: string
): Effect.Effect<ReadonlyArray<string>> => InternalDescriptor.getFishCompletions(self.descriptor, programName)

/** @internal */
export const getZshCompletions = <Name extends string, R, E, A>(
  self: Command.Command<Name, R, E, A>,
  programName: string
): Effect.Effect<ReadonlyArray<string>> => InternalDescriptor.getZshCompletions(self.descriptor, programName)
