...
export const EmptyTypeId = Symbol.for(
  "@effect-ts/system/collection/immutable/Chunk/Empty"
)
...
export const AppendNTypeId = Symbol.for(
  "@effect-ts/system/collection/immutable/Chunk/AppendN"
)
...
export const ArrTypeId = Symbol.for("@effect-ts/system/collection/immutable/Chunk/Arr")
...
export const SliceTypeId = Symbol.for(
  "@effect-ts/system/collection/immutable/Chunk/Slice"
)
...
export const SingletonTypeId = Symbol.for(
  "@effect-ts/system/collection/immutable/Chunk/Singleton"
)
...
export const PrependNTypeId = Symbol.for(
  "@effect-ts/system/collection/immutable/Chunk/PrependN"
)
...
export const ConcatTypeId = Symbol.for(
  "@effect-ts/system/collection/immutable/Chunk/Concat"
)
 ...
 * Type guard
 *
 * @tsplus static ets/ChunkOps isChunk
 */
 ...
 *
 * @tsplus static ets/ChunkOps from
 */
...
export function corresponds<A, B>(
  ...
  return (self) => self.corresponds(that, f)
}
