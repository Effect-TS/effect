...
declare module "../utils/hkt" {
  export interface Algebra<F, Env> {
    [ObjectURI]: AlgebraObject<F, Env>
  }
  export interface Algebra1<F extends URIS, Env extends AnyEnv> {
    [ObjectURI]: AlgebraObject1<F, Env>
  }
  export interface Algebra2<F extends URIS2, Env extends AnyEnv> {
    [ObjectURI]: AlgebraObject2<F, Env>
  }
}
...
export interface AlgebraObject<F, Env> {
  _F: F
  interface: {
...
export interface AlgebraObject1<F extends URIS, Env extends AnyEnv> {
  _F: F
  interface: <Props>(
...
export interface AlgebraObject2<F extends URIS2, Env extends AnyEnv> {
  _F: F
