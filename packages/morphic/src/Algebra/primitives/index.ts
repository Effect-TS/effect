...
export interface AlgebraPrimitive<F, Env> {
  ...
  nullable: {
    <L, A>(
      T: HKT2<F, Env, L, A>,
      config?: Named<ConfigsForType<Env, L | null, Option<A>, NullableConfig<L, A>>>
  ...
  boolean: {
    (config?: Named<ConfigsForType<Env, boolean, boolean, BooleanConfig>>): HKT2<
      F,
      Env,
      boolean,
      boolean
  ...
  number: {
    (config?: Named<ConfigsForType<Env, number, number, NumberConfig>>): HKT2<
      F,
      Env,
      number,
      number
  ...
  bigint: {
    (config?: Named<ConfigsForType<Env, string, bigint, BigIntConfig>>): HKT2<
      F,
      Env,
      string,
      bigint
  ...
  string: {
    (config?: Named<ConfigsForType<Env, string, string, StringConfig>>): HKT2<
      F,
      Env,
      string,
      string
  ...
  date: {
    (config?: Named<ConfigsForType<Env, string, Date, DateConfig>>): HKT2<
      F,
      Env,
      string,
      Date
  ...
  uuid: {
    (config?: Named<ConfigsForType<Env, string, UUID, UUIDConfig>>): HKT2<
      F,
      Env,
      string,
      UUID
...
export interface AlgebraPrimitive1<F extends URIS, Env extends AnyEnv> {
  ...
  unknownE: {
    <A>(
      T: Kind<F, Env, A>,
      config?: Named<ConfigsForType<Env, unknown, A, UnknownEConfig<unknown, A>>>
    ): Kind<F, Env, A>
  }
  nullable: <A>(
    T: Kind<F, Env, A>,
    config?: Named<ConfigsForType<Env, null | A, Option<A>, NullableConfig<unknown, A>>>
  ) => Kind<F, Env, Option<A>>
  mutable: {
    <A>(
      T: Kind<F, Env, A>,
      config?: Named<
        ConfigsForType<Env, unknown, Mutable<A>, MutableConfig<unknown, A>>
      >
  ...
  boolean(
    config?: Named<ConfigsForType<Env, boolean, boolean, BooleanConfig>>
  ): Kind<F, Env, boolean>
  number(
  ...
  array: <A>(
    a: Kind<F, Env, A>,
    config?: Named<
      ConfigsForType<Env, Array<unknown>, Array<A>, ArrayConfig<unknown, A>>
    >
  ) => Kind<F, Env, Array<A>>
  nonEmptyArray: <A>(
    a: Kind<F, Env, A>,
  ...
  option: {
    <A>(
      a: Kind<F, Env, A>,
      config?: Named<ConfigsForType<Env, unknown, Option<A>, OptionConfig<unknown, A>>>
    ): Kind<F, Env, Option<A>>
  }
}
