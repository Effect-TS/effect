...
export type ResolverF<U extends string, Ctx, A, B, C, D> = (
  _: ResolverInput<A>
) => T.Effect<B & ContextEnv<U, Ctx>, C, D>;

export interface ResolverSubF<U extends string, Ctx, A, B, C, D, E, F, G> {
  subscribe: (_: ResolverInput<A>) => T.Effect<B & ContextEnv<U, Ctx>, C, AsyncIterable<D>>;
  resolve?: (_: D) => T.Effect<E & ContextEnv<U, Ctx>, F, G>;
}

export type Resolver<K, U extends string, Ctx> = {
  [k in keyof K]:
    | ResolverF<U, Ctx, unknown, any, any, any>
    | ResolverSubF<U, Ctx, unknown, any, any, any, any, any, any>;
};

export type ResolverEnv<R, U extends string, Ctx> = R extends Resolver<any, U, Ctx>
