...
type MatechsURIS = "matechs/prelude/MIO";

interface GenEffect<R, E, A> {
  _TAG: () => "MIO" | "MResource" | "MStream" | "MStreamEither";
  _R: (_: R) => void;
  _E: () => E;
  _A: () => A;
}
...
declare module "fp-ts-contrib/lib/Do" {
  export function Do<M extends MatechsURIS>(M: Monad3E<M>): Do3CE<M, {}, unknown, never>;
  export function Do<M extends MatechsURIS, E>(M: Monad3EC<M, E>): Do3CE_<M, {}, unknown, E>;
}
