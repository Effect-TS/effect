import { afterAll, describe, expect, it, layer } from "@effect/bun-test"
...
describe("layer", () => {
  layer(Foo.Live)((it) => {
    ...
    describe("release", () => {
      ...
      // afterAll declared AFTER the it.layer block above so that Bun runs the
      // layer's own afterAll (which closes the scope and flips `released`)
