...
describe("Integer", () => {
  ...
  it("greaterThan", () => {
    ...
    const isFourGreaterThanNegativeTwo = Integer.greaterThan(four, negativeTwo)
  ...
  it("greaterThanOrEqualTo", () => {
    ...
    const isFourGreaterThanOrEqualToNegativeTwo = Integer.greaterThanOrEqualTo(
      four,
      negativeTwo
    )
  ...
  it("multiplyAll", () => {
    strictEqual(
      Integer.multiplyAll(Array.of(Integer.of(2), Integer.zero, Integer.of(4))),
      Integer.zero
    )
