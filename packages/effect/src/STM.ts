...
import type { YieldKey } from "./Utils.js"
 ...
 * @category constructors
 */
export const gen: <Eff extends YieldKey<STM<any, any, any>>, AEff>(
  f: (resume: Adapter) => Generator<Eff, AEff, never>
) => STM<
  AEff,
  [Eff] extends [never] ? never : [Eff] extends [YieldKey<STM<infer _A, infer E, infer _R>>] ? E : never,
  [Eff] extends [never] ? never : [Eff] extends [YieldKey<STM<infer _A, infer _E, infer R>>] ? R : never
> = stm.gen
