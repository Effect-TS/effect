import { HasURI, HKT5, Kind5, Kind6, URIS5, URIS6 } from "../HKT"
...
export interface ContravariantInput5<F extends URIS5> extends HasURI<F> {
  readonly ContravariantInput: "ContravariantInput"
  readonly contramapInput: <In1, In>(
    f: (a: In1) => In
  ) => <S, R, E, A>(fa: Kind5<F, In, S, R, E, A>) => Kind5<F, In1, S, R, E, A>
}
...
export function makeContravariantInput<URI extends URIS5>(
  _: URI
): (
  _: Omit<ContravariantInput5<URI>, "URI" | "ContravariantInput">
) => ContravariantInput5<URI>
