...
/**
 * Transforms both elements of a 2-tuple using the given functions.
 *
 * @example
 * ```ts
 * import * as assert from "node:assert"
...
/**
 * Transforms the first component of a 2-tuple using a given function.
 *
 * @example
 * ```ts
 * import * as assert from "node:assert"
...
/**
 * Transforms the second component of a 2-tuple using a given function.
 *
 * @example
 * ```ts
 * import * as assert from "node:assert"
...
/**
 * Swaps the two elements of a 2-tuple.
 *
 * @example
 * ```ts
 * import * as assert from "node:assert"
