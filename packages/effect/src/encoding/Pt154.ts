/**
 * PT154 character encoding with typed failures and Effect streams.
 *
 * @since 4.0.0
 */
...
/**
 * The pt154 codec descriptor, for use with the CharacterEncoding operators.
 *
 * @category encodings
 * @since 4.0.0
 */
...
/**
 * Encodes a complete string to pt154 bytes, throwing CharacterEncodingError on failure.
 *
 * @category encoding
 * @since 4.0.0
 */
...
/**
 * Decodes complete pt154 bytes to a string, throwing CharacterEncodingError on failure.
 *
 * @category decoding
 * @since 4.0.0
 */
...
/**
 * Encodes a string to pt154 bytes with conversion errors in the Effect error channel.
 *
 * @category encoding
 * @since 4.0.0
 */
...
/**
 * Decodes pt154 bytes to a string with conversion errors in the Effect error channel.
 *
 * @category decoding
 * @since 4.0.0
 */
...
/**
 * Encodes a stream of strings to pt154 bytes incrementally, preserving codec state across chunks.
 *
 * @category streaming
 * @since 4.0.0
 */
...
/**
 * Decodes a stream of pt154 bytes to strings incrementally, retaining partial sequences across chunks.
 *
 * @category streaming
 * @since 4.0.0
 */
