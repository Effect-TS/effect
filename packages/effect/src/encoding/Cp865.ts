/**
 * CP865 character encoding with typed failures and Effect streams.
 *
 * @since 4.0.0
 */
...
import data from "../internal/characterEncoding/cp865Data.ts"
...
/**
 * The cp865 codec descriptor, for use with the CharacterEncoding operators.
 *
 * @category encodings
 * @since 4.0.0
 */
export const encoding: Encoding = /* @__PURE__ */ make("cp865", () => new SingleByte(data))

/**
 * Encodes a complete string to cp865 bytes, throwing CharacterEncodingError on failure.
 *
 * @category encoding
 * @since 4.0.0
 */
...
/**
 * Decodes complete cp865 bytes to a string, throwing CharacterEncodingError on failure.
 *
 * @category decoding
 * @since 4.0.0
 */
...
/**
 * Encodes a string to cp865 bytes with conversion errors in the Effect error channel.
 *
 * @category encoding
 * @since 4.0.0
 */
...
/**
 * Decodes cp865 bytes to a string with conversion errors in the Effect error channel.
 *
 * @category decoding
 * @since 4.0.0
 */
...
/**
 * Encodes a stream of strings to cp865 bytes incrementally, preserving codec state across chunks.
 *
 * @category streaming
 * @since 4.0.0
 */
...
/**
 * Decodes a stream of cp865 bytes to strings incrementally, retaining partial sequences across chunks.
 *
 * @category streaming
 * @since 4.0.0
 */
