/**
 * MIK character encoding with typed failures and Effect streams.
 *
 * @since 4.0.0
 */
...
import data from "../internal/characterEncoding/mikData.ts"
...
/**
 * The mik codec descriptor, for use with the CharacterEncoding operators.
 *
 * @category encodings
 * @since 4.0.0
 */
export const encoding: Encoding = /* @__PURE__ */ make("mik", () => new SingleByte(data))

/**
 * Encodes a complete string to mik bytes, throwing CharacterEncodingError on failure.
 *
 * @category encoding
 * @since 4.0.0
 */
...
/**
 * Decodes complete mik bytes to a string, throwing CharacterEncodingError on failure.
 *
 * @category decoding
 * @since 4.0.0
 */
...
/**
 * Encodes a string to mik bytes with conversion errors in the Effect error channel.
 *
 * @category encoding
 * @since 4.0.0
 */
...
/**
 * Decodes mik bytes to a string with conversion errors in the Effect error channel.
 *
 * @category decoding
 * @since 4.0.0
 */
...
/**
 * Encodes a stream of strings to mik bytes incrementally, preserving codec state across chunks.
 *
 * @category streaming
 * @since 4.0.0
 */
...
/**
 * Decodes a stream of mik bytes to strings incrementally, retaining partial sequences across chunks.
 *
 * @category streaming
 * @since 4.0.0
 */
