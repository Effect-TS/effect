/**
 * MACROMANIA character encoding with typed failures and Effect streams.
 *
 * @since 4.0.0
 */
...
/**
 * The macromania codec descriptor, for use with the CharacterEncoding operators.
 *
 * @category encodings
 * @since 4.0.0
 */
...
/**
 * Encodes a complete string to macromania bytes, throwing CharacterEncodingError on failure.
 *
 * @category encoding
 * @since 4.0.0
 */
...
/**
 * Decodes complete macromania bytes to a string, throwing CharacterEncodingError on failure.
 *
 * @category decoding
 * @since 4.0.0
 */
...
/**
 * Encodes a string to macromania bytes with conversion errors in the Effect error channel.
 *
 * @category encoding
 * @since 4.0.0
 */
...
/**
 * Decodes macromania bytes to a string with conversion errors in the Effect error channel.
 *
 * @category decoding
 * @since 4.0.0
 */
...
/**
 * Encodes a stream of strings to macromania bytes incrementally, preserving codec state across chunks.
 *
 * @category streaming
 * @since 4.0.0
 */
...
/**
 * Decodes a stream of macromania bytes to strings incrementally, retaining partial sequences across chunks.
 *
 * @category streaming
 * @since 4.0.0
 */
