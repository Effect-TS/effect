/**
 * ISO88598 character encoding with typed failures and Effect streams.
 *
 * @since 4.0.0
 */
...
/**
 * Encodes a complete string to iso88598 bytes, throwing CharacterEncodingError on failure.
 *
 * @category encoding
 * @since 4.0.0
 */
...
/**
 * Decodes complete iso88598 bytes to a string, throwing CharacterEncodingError on failure.
 *
 * @category decoding
 * @since 4.0.0
 */
...
/**
 * Encodes a string to iso88598 bytes with conversion errors in the Effect error channel.
 *
 * @category encoding
 * @since 4.0.0
 */
...
/**
 * Decodes iso88598 bytes to a string with conversion errors in the Effect error channel.
 *
 * @category decoding
 * @since 4.0.0
 */
...
/**
 * Encodes a stream of strings to iso88598 bytes incrementally, preserving codec state across chunks.
 *
 * @category streaming
 * @since 4.0.0
 */
...
/**
 * Decodes a stream of iso88598 bytes to strings incrementally, retaining partial sequences across chunks.
 *
 * @category streaming
 * @since 4.0.0
 */
