...
// Merges sorted `values` in, existing elements first on ties. Each value is
// searched for in steps of the expected gap, so one value is one binary search.
