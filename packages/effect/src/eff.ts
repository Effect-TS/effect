...
export type RT<S, R, E, A> = unknown extends S ? AsyncEff<R, E, A> : SyncEff<R, E, A>;
...
export const zipWith: <S1, S2, R, E, A, R2, E2, B, C>(
  ...
  f: F.FunctionN<[A, B], C>
) => RT<S1 | S2, R & R2, E | E2, C> = T.zipWith as any;

export const zip: <S1, S2, R, E, A, R2, E2, B>(
  first: Eff<S1, R, E, A>,
  second: Eff<S2, R2, E2, B>
) => RT<S1 | S2, R & R2, E | E2, readonly [A, B]> = T.zip as any;
...
export const applyFirst: <S1, S2, R, E, A, R2, E2, B>(
  first: Eff<S1, R, E, A>,
  second: Eff<S2, R2, E2, B>
) => RT<S1 | S2, R & R2, E | E2, A> = T.applyFirst as any;

export const applySecond: <S1, S2, R, E, A, R2, E2, B>(
  first: Eff<S1, R, E, A>,
  second: Eff<S2, R2, E2, B>
) => RT<S1 | S2, R & R2, E | E2, B> = T.applySecond as any;

export const applySecondL: <S1, S2, R, E, A, R2, E2, B>(
  first: Eff<S1, R, E, A>,
  second: F.Lazy<Eff<S2, R2, E2, B>>
) => RT<S1 | S2, R & R2, E | E2, B> = T.applySecondL as any;

export const ap__: <S1, S2, R, E, A, R2, E2, B>(
  ioa: Eff<S1, R, E, A>,
  iof: Eff<S2, R2, E2, F.FunctionN<[A], B>>
) => RT<S1 | S2, R & R2, E | E2, B> = T.ap__ as any;

export const flip: <S, R, E, A>(io: Eff<S, R, E, A>) => RT<S, R, A, E> = T.flip as any;

export const forever: <S, R, E, A>(io: Eff<S, R, E, A>) => RT<S, R, E, never> = T.forever as any;

export const raised: <E, A = never>(e: ex.Cause<E>) => SyncEff<T.NoEnv, E, A> = T.raised as any;

export const raiseError: <E, A = never>(e: E) => SyncEff<T.NoEnv, E, A> = T.raiseError as any;

export const raiseAbort: (u: unknown) => SyncEff<T.NoEnv, T.NoErr, never> = T.raiseAbort as any;

export const raiseInterrupt: SyncEff<T.NoEnv, T.NoErr, never> = T.raiseInterrupt as any;

export const completed: <E, A>(exit: ex.Exit<E, A>) => SyncEff<T.NoEnv, E, A> = T.completed as any;

export const suspended: <S, R, E, A>(thunk: F.Lazy<Eff<S, R, E, A>>) => RT<S, R, E, A> =
  T.suspended as any;

export const sync: <E = T.NoErr, A = unknown>(thunk: F.Lazy<A>) => SyncEff<T.NoEnv, E, A> =
  T.sync as any;

export const trySync: <E = unknown, A = unknown>(thunk: F.Lazy<A>) => SyncEff<T.NoEnv, E, A> =
  T.trySync as any;

export const trySyncMap: <E = unknown>(
  onError: (e: unknown) => E
) => <A = unknown>(thunk: F.Lazy<A>) => SyncEff<T.NoEnv, E, A> = T.trySyncMap as any;

export const async: <E, A>(op: T.AsyncFn<E, A>) => AsyncEff<T.NoEnv, E, A> = T.async as any;
...
export const interruptibleRegion: <S, R, E, A>(
  inner: Eff<S, R, E, A>,
  flag: boolean
) => RT<S, R, E, A> = T.interruptibleRegion as any;

export const encaseOption: <E, A>(o: Op.Option<A>, onError: F.Lazy<E>) => SyncEff<T.NoEnv, E, A> =
  T.encaseOption as any;

export const chainOption: <E>(
  onEmpty: F.Lazy<E>
) => <A, B>(
  bind: F.FunctionN<[A], Op.Option<B>>
) => <S, R, E2>(eff: Eff<S, R, E2, A>) => RT<S, R, E | E2, B> = T.chainOption as any;

export const encaseEither: <E, A>(e: Ei.Either<E, A>) => SyncEff<T.NoEnv, E, A> =
  T.encaseEither as any;

export const chainEither: <A, E, B>(
  bind: F.FunctionN<[A], Ei.Either<E, B>>
) => <S, R, E2>(eff: Eff<S, R, E2, A>) => RT<S, R, E | E2, B> = T.chainEither as any;

export const chainError: <S1, R, E1, E2, A>(
  f: F.FunctionN<[E1], Eff<S1, R, E2, A>>
) => <S2, R2>(rio: Eff<S2, R2, E1, A>) => RT<S1 | S2, R & R2, E2, A> = T.chainError as any;

export const mapError: <E1, E2>(
  f: F.FunctionN<[E1], E2>
) => <S, R, A>(io: Eff<S, R, E1, A>) => RT<S, R, E2, A> = T.mapError as any;

export const orAbort: <S, R, E, A>(io: Eff<S, R, E, A>) => RT<S, R, T.NoErr, A> = T.orAbort as any;

export const uninterruptible: <S, R, E, A>(io: Eff<S, R, E, A>) => RT<S, R, E, A> =
  T.uninterruptible as any;

export const interruptible: <S, R, E, A>(io: Eff<S, R, E, A>) => RT<S, R, E, A> =
  T.interruptible as any;

export const after: (ms: number) => AsyncEff<T.NoEnv, T.NoErr, void> = T.after as any;

export const fromPromise: <A>(thunk: F.Lazy<Promise<A>>) => AsyncEff<T.NoEnv, unknown, A> =
  T.fromPromise as any;

export const encaseTask: <A>(task: TA.Task<A>) => AsyncEff<T.NoEnv, T.NoErr, A> =
  T.encaseTask as any;

export const chainTask: <A, B>(
  bind: F.FunctionN<[A], TA.Task<B>>
) => <S, R, E2>(eff: Eff<S, R, E2, A>) => RT<S | ASYNC, R, E2, B> = T.chainTask as any;

export const encaseTaskEither: <E, A>(taskEither: TE.TaskEither<E, A>) => AsyncEff<T.NoEnv, E, A> =
  T.encaseTaskEither as any;

export const chainTaskEither: <A, E, B>(
  bind: F.FunctionN<[A], TE.TaskEither<E, B>>
) => <S, R, E2>(eff: Eff<S, R, E2, A>) => AsyncEff<R, E | E2, B> = T.chainTaskEither as any;

export const accessInterruptible: SyncEff<T.NoEnv, T.NoErr, boolean> =
  new T.EffectIO(T.EffectTag.AccessInterruptible, F.identity) as any;

export const accessRuntime: SyncEff<T.NoEnv, T.NoErr, Runtime> =
...
) => RT<S, T.NoEnv, E, A> = T.withRuntime as any;

export const accessEnvironment: <R>() => SyncEff<R, T.NoErr, R> = T.accessEnvironment as any;

export const accessM: <S, R, R2, E, A>(
  f: F.FunctionN<[R], Eff<S, R2, E, A>>
) => RT<S, R & R2, E, A> = T.accessM as any;

export const access: <R, A, E = T.NoErr>(f: F.FunctionN<[R], A>) => SyncEff<R, E, A> =
  T.access as any;

export const mergeEnv: <A>(a: A) => <B>(b: B) => A & B = T.mergeEnv;

export const provideAll: <R>(r: R) => <S, E, A>(ma: Eff<S, R, E, A>) => RT<S, unknown, E, A> =
  T.provideAll as any;

export const provide: <R>(r: R) => <S, R2, E, A>(ma: Eff<S, R2 & R, E, A>) => RT<S, R2, E, A> =
  T.provide as any;
...
export const provideM: <S1, R2, R, E2>(f: Eff<S1, R2, E2, R>) => Provider<R2, R, S1, E2> =
  T.provideM as any;

export const provideSomeM: <S1, R2, R, E2>(f: Eff<S1, R2, E2, R>) => Provider<R2, R, S1, E2> =
  T.provideSomeM as any;

export const lift: <A, B>(
  f: F.FunctionN<[A], B>
) => <S, R, E>(io: Eff<S, R, E, A>) => RT<S, R, E, B> = T.lift as any;
...
export interface EffMonad
  ...
  ): RT<S1 | S2 | S3, R & R2 & R3, E2 | E3, A2 | A3>;
...
) => <S2, R2, E2>(inner: Eff<S2, R2, E2, A>) => RT<S1 | S2, R & R2, E | E2, A> = T.chainTap as any;

export const as: <S, R, E, A, B>(io: Eff<S, R, E, A>, b: B) => RT<S, R, E, B> = T.as as any;

export const asUnit: <S, R, E, A>(io: Eff<S, R, E, A>) => RT<S, R, E, void> = T.asUnit as any;
...
) => RT<S, R, E, A> = T.uninterruptibleMask as any;

export const result: <S, R, E, A>(io: Eff<S, R, E, A>) => RT<S, R, T.NoErr, ex.Exit<E, A>> =
  T.result as any;
...
) => RT<S1 | S2 | S3, R & R2 & R3, E | E2 | E3, B> = T.bracketExit as any;

export const bracket: <S1, S2, S3, R, E, A, R2, E2, R3, E3, B>(
  acquire: Eff<S1, R, E, A>,
  release: F.FunctionN<[A], Eff<S2, R2, E2, unknown>>,
  use: F.FunctionN<[A], Eff<S3, R3, E3, B>>
) => RT<S1 | S2 | S3, R & R2 & R3, E | E2 | E3, B> = T.bracket as any;

export const onComplete: <S2, R2, E2>(
  finalizer: Eff<S2, R2, E2, unknown>
) => <S1, R, E, A>(ioa: Eff<S1, R, E, A>) => RT<S1 | S2, R & R2, E | E2, A> = T.onComplete as any;

export const onInterrupted: <S2, R2, E2>(
  finalizer: Eff<S2, R2, E2, unknown>
) => <S1, R, E, A>(ioa: Eff<S1, R, E, A>) => RT<S2 | S1, R & R2, E2 | E, A> =
  T.onInterrupted as any;

export const combineInterruptExit: <S1, S2, R, E, A, R2, E2>(
  ioa: Eff<S1, R, E, A>,
  finalizer: Eff<S2, R2, E2, ex.Interrupt[]>
) => RT<S1 | S2, R & R2, E | E2, A> = T.combineInterruptExit as any;

export const shifted: AsyncEff<T.NoEnv, T.NoErr, void> = T.shifted as any;

export const shiftBefore: <S, R, E, A>(io: Eff<S, R, E, A>) => AsyncEff<R, E, A> =
  T.shiftBefore as any;

export const shiftAfter: <S, R, E, A>(io: Eff<S, R, E, A>) => AsyncEff<R, E, A> =
  T.shiftAfter as any;

export const never: AsyncEff<T.NoEnv, T.NoErr, never> = T.never as any;

export const delay: <S, R, E, A>(inner: Eff<S, R, E, A>, ms: number) => AsyncEff<R, E, A> =
  T.delay as any;

export const liftDelay: (ms: number) => <S, R, E, A>(io: Eff<S, R, E, A>) => AsyncEff<R, E, A> =
  T.liftDelay as any;

export interface Fiber<S, E, A> {
  readonly name: Op.Option<string>;
  readonly interrupt: RT<S, T.NoEnv, T.NoErr, ex.Interrupt>;
  ...
  readonly isComplete: RT<S, T.NoEnv, T.NoErr, boolean>;
}
...
) => RT<S1 | S2 | S3 | S4, R & R2 & R3 & R4, E3, C> = T.raceFold as any;
...
export const raceFirst: <S1, S2, R, R2, E, A>(
  io1: Eff<S1, R, E, A>,
  io2: Eff<S2, R2, E, A>
) => RT<S1 | S2, R & R2, E, A> = T.raceFirst as any;
...
export const encaseSyncOrAbort = <R, E, A>(_: T.Effect<R, E, A>): SyncEff<R, E, A> =>
  pipe(
