...
export type RT<S, R, E, A> = unknown extends S
  ? AsyncEff<R, E, A>
  : SyncEff<R, E, A>;
...
export const flip: <S, R, E, A>(io: Eff<S, R, E, A>) => RT<S, R, A, E> =
  T.flip as any;

export const forever: <S, R, E, A>(io: Eff<S, R, E, A>) => RT<S, R, E, never> =
  T.forever as any;

export const raised: <E, A = never>(e: ex.Cause<E>) => SyncEff<T.NoEnv, E, A> =
  T.raised as any;

export const raiseError: <E, A = never>(e: E) => SyncEff<T.NoEnv, E, A> =
  T.raiseError as any;

export const raiseAbort: (u: unknown) => SyncEff<T.NoEnv, T.NoErr, never> =
  T.raiseAbort as any;

export const raiseInterrupt: SyncEff<T.NoEnv, T.NoErr, never> =
  T.raiseInterrupt as any;

export const completed: <E, A>(exit: ex.Exit<E, A>) => SyncEff<T.NoEnv, E, A> =
  T.completed as any;

export const suspended: <S, R, E, A>(
  thunk: F.Lazy<Eff<S, R, E, A>>
) => RT<S, R, E, A> = T.suspended as any;
...
export const async: <E, A>(op: T.AsyncFn<E, A>) => AsyncEff<T.NoEnv, E, A> =
  T.async as any;
...
) => <S, R, E2>(eff: Eff<S, R, E2, A>) => RT<S, R, E | E2, B> =
  T.chainOption as any;
...
export const orAbort: <S, R, E, A>(
  io: Eff<S, R, E, A>
) => RT<S, R, T.NoErr, A> = T.orAbort as any;

export const uninterruptible: <S, R, E, A>(
  io: Eff<S, R, E, A>
) => RT<S, R, E, A> = T.uninterruptible as any;

export const interruptible: <S, R, E, A>(
  io: Eff<S, R, E, A>
) => RT<S, R, E, A> = T.interruptible as any;

export const after: (ms: number) => AsyncEff<T.NoEnv, T.NoErr, void> =
  T.after as any;
...
) => <S, R, E2>(eff: Eff<S, R, E2, A>) => RT<S | ASYNC, R, E2, B> =
  T.chainTask as any;
...
export const accessEnvironment: <R>() => SyncEff<R, T.NoErr, R> =
...
export const provideAll: <R>(
  r: R
) => <S, E, A>(ma: Eff<S, R, E, A>) => RT<S, unknown, E, A> =
  T.provideAll as any;

export const provide: <R>(
  r: R
) => <S, R2, E, A>(ma: Eff<S, R2 & R, E, A>) => RT<S, R2, E, A> =
  T.provide as any;
...
export const provideS: <R>(r: R) => Provider<unknown, R, SYNC, never> =
  T.provideS as any;

export const provideSO: <R>(r: R) => Provider<unknown, R, SYNC, never> =
  T.provideSO as any;
...
) => <S2, R2, E2>(inner: Eff<S2, R2, E2, A>) => RT<S1 | S2, R & R2, E | E2, A> =
  T.chainTap as any;

export const as: <S, R, E, A, B>(io: Eff<S, R, E, A>, b: B) => RT<S, R, E, B> =
  T.as as any;

export const asUnit: <S, R, E, A>(io: Eff<S, R, E, A>) => RT<S, R, E, void> =
  T.asUnit as any;
...
export const result: <S, R, E, A>(
  io: Eff<S, R, E, A>
) => RT<S, R, T.NoErr, ex.Exit<E, A>> = T.result as any;
...
export const onComplete: <S2, R2, E2>(
  finalizer: Eff<S2, R2, E2, unknown>
) => <S1, R, E, A>(ioa: Eff<S1, R, E, A>) => RT<S1 | S2, R & R2, E | E2, A> =
  T.onComplete as any;
...
export const runToPromise: <S, E, A>(io: Eff<S, {}, E, A>) => Promise<A> =
  T.runToPromise as any;
