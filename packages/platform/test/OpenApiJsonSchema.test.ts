...
schema (Declaration): DateFromSelf`
  ...
  it("Any", () => {
    expectJSONSchemaProperty(Schema.Any, {
      "$id": "/schemas/any",
      "title": "any"
    })
  })
  ...
  it("Unknown", () => {
    expectJSONSchemaProperty(Schema.Unknown, {
      "$id": "/schemas/unknown",
      "title": "unknown"
    })
  })
  ...
  it("Void", () => {
    expectJSONSchemaProperty(Schema.Void, {
      "$id": "/schemas/void",
      "title": "void"
    })
  })
  ...
  it("Object", () => {
    ...
    expectJSONSchemaProperty(Schema.Object, jsonSchema)
    const validate = getAjvValidate(jsonSchema)
  ...
  it("String", () => {
    expectJSONSchemaProperty(Schema.String, {
      type: "string"
    })
    expectJSONSchemaProperty(Schema.String.annotations({}), {
      type: "string"
    })
  })
  ...
  it("Boolean", () => {
    expectJSONSchemaProperty(Schema.Boolean, {
      type: "boolean"
    })
    expectJSONSchemaProperty(Schema.Boolean.annotations({}), {
      type: "boolean"
    })
  })
  ...
  describe("Literal", () => {
    it("Null", () => {
      expectJSONSchemaProperty(Schema.Null, {
        "enum": [null]
      })
    })

    it("string literals", () => {
      expectJSONSchemaProperty(Schema.Literal("a"), {
        "enum": ["a"]
      })
    })

    it("number literals", () => {
      expectJSONSchemaProperty(Schema.Literal(1), {
        "enum": [1]
      })
    })

    it("boolean literals", () => {
      expectJSONSchemaProperty(Schema.Literal(true), {
        "enum": [true]
      })
      expectJSONSchemaProperty(Schema.Literal(false), {
        "enum": [false]
      })
    })
  })
  ...
  describe("Enums", () => {
    it("numeric enums", () => {
      ...
      expectJSONSchemaProperty(Schema.Enums(Fruits), {
  ...
  describe("Union", () => {
    it("string | number", () => {
      expectJSONSchemaProperty(Schema.Union(Schema.String, JsonNumber), {
        "anyOf": [
          {
            "type": "string"
          },
    ...
    it(`1 | "a"`, () => {
      expectJSONSchemaProperty(Schema.Literal(1, 2), {
        "enum": [1, 2]
      })
    })

    it(`1 | true | string`, () => {
      expectJSONSchemaProperty(Schema.Union(Schema.Literal(1, true), Schema.String), {
        "anyOf": [
          { "enum": [1, true] },
          { "type": "string" }
        ]
...
schema (SymbolKeyword): symbol`
    ...
    it("Record(string, number)", () => {
      expectJSONSchemaProperty(Schema.Record({ key: Schema.String, value: JsonNumber }), {
        "type": "object",
        "properties": {},
        "required": [],
        "patternProperties": {
...
schema (Refinement): { string | filter }`
    ...
    it("minLength", () => {
      expectJSONSchemaProperty(Schema.String.pipe(Schema.minLength(1)), {
        "type": "string",
        "description": "a string at least 1 character(s) long",
        "minLength": 1
      })
    ...
    it("maxLength", () => {
      expectJSONSchemaProperty(Schema.String.pipe(Schema.maxLength(1)), {
        "type": "string",
    ...
    it("length: number", () => {
      expectJSONSchemaProperty(Schema.String.pipe(Schema.length(1)), {
        "type": "string",
    ...
    it("length: { min, max }", () => {
      expectJSONSchemaProperty(Schema.String.pipe(Schema.length({ min: 2, max: 4 })), {
        "type": "string",
    ...
    it("pattern", () => {
      expectJSONSchemaProperty(Schema.String.pipe(Schema.pattern(/^abb+$/)), {
        "type": "string",
...
schema (Suspend): <suspended schema>`
  ...
  describe("annotations", () => {
    it("examples support", () => {
      expectJSONSchemaProperty(Schema.String.annotations({ examples: ["a", "b"] }), {
        "type": "string",
        "examples": ["a", "b"]
      })
    })
    ...
    it("default support", () => {
      expectJSONSchemaProperty(Schema.String.annotations({ default: "" }), {
        "type": "string",
        "default": ""
      })
    })
  ...
  describe("identifier annotations support", () => {
    it("on root level schema", () => {
      expectJSONSchemaProperty(Schema.String.annotations({ identifier: "Name" }), {
        "$ref": "#/$defs/Name",
        "$defs": {
          "Name": {
            "type": "string"
