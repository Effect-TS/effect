...
export declare namespace HttpApi {
   ...
   * @category models
   */
  export type ToService<Api extends Any> = HttpApiGroup.HttpApiGroup.ToService<Groups<Api>>
  /**
   * @since 1.0.0
   * @category models
   */
  export type Groups<A extends Any> = A extends HttpApi<infer _Groups, infer _E, infer _R> ? _Groups
    : never
   ...
   * @category models
   */
  export type Context<A extends Any> = A extends HttpApi<infer _Groups, infer _E, infer _R> ? _R
    : never
   ...
   * @category models
   */
  export type Middleware<A extends Any> = HttpApiMiddleware.HttpApiMiddleware.Only<Context<A>>
}
