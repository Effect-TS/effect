...
- [#8479](https://github.com/Effect-TS/effect/pull/8479) [`0f42b56`](https://github.com/Effect-TS/effect/commit/0f42b56447002b9884acbfbe6fbf8acc9683d060) Thanks @tim-smart! - Map malformed Anthropic-compatible gateway 4xx errors by status instead of `InvalidOutputError`, including 429 retry delays. Direct `AnthropicClient.client.betaMessagesPost` calls now fail with `HttpClientError` instead of `SchemaError` for these responses.

- [#8478](https://github.com/Effect-TS/effect/pull/8478) [`92e9151`](https://github.com/Effect-TS/effect/commit/92e91511e3b448fac74ce0a90cecc094731d0540) Thanks @tim-smart! - Accept message responses that omit `usage.inference_geo`, as some Anthropic-compatible gateways do.
