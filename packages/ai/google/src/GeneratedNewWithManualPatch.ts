...
*/
export class ListFileSearchStoresResponse extends S.Class<ListFileSearchStoresResponse>("ListFileSearchStoresResponse")({
  /**
...
*/
export class FunctionResponseScheduling extends S.Literal("SCHEDULING_UNSPECIFIED", "SILENT", "WHEN_IDLE", "INTERRUPT") {}
...
*/
export class CodeExecutionResultOutcome extends S.Literal("OUTCOME_UNSPECIFIED", "OUTCOME_OK", "OUTCOME_FAILED", "OUTCOME_DEADLINE_EXCEEDED") {}
...
*/
export class GenerationConfigMediaResolution extends S.Literal("MEDIA_RESOLUTION_UNSPECIFIED", "MEDIA_RESOLUTION_LOW", "MEDIA_RESOLUTION_MEDIUM", "MEDIA_RESOLUTION_HIGH") {}
...
*/
export class ThinkingConfigThinkingLevel extends S.Literal("THINKING_LEVEL_UNSPECIFIED", "LOW", "HIGH") {}
...
*/
export class SafetySettingThreshold extends S.Literal("HARM_BLOCK_THRESHOLD_UNSPECIFIED", "BLOCK_LOW_AND_ABOVE", "BLOCK_MEDIUM_AND_ABOVE", "BLOCK_ONLY_HIGH", "BLOCK_NONE", "OFF") {}
...
*/
export class SafetyRatingProbability extends S.Literal("HARM_PROBABILITY_UNSPECIFIED", "NEGLIGIBLE", "LOW", "MEDIUM", "HIGH") {}
...
* Rephrase the prompt.
*/
export class PromptFeedbackBlockReason extends S.Literal("BLOCK_REASON_UNSPECIFIED", "SAFETY", "OTHER", "BLOCKLIST", "PROHIBITED_CONTENT", "IMAGE_SAFETY") {}
...
*/
export class UrlMetadataUrlRetrievalStatus extends S.Literal("URL_RETRIEVAL_STATUS_UNSPECIFIED", "URL_RETRIEVAL_STATUS_SUCCESS", "URL_RETRIEVAL_STATUS_ERROR", "URL_RETRIEVAL_STATUS_PAYWALL", "URL_RETRIEVAL_STATUS_UNSAFE") {}
...
export class GenerativeLanguageModality extends S.Literal("MODALITY_UNSPECIFIED", "TEXT", "IMAGE", "VIDEO", "AUDIO", "DOCUMENT") {}
...
export class BatchState extends S.Literal("BATCH_STATE_UNSPECIFIED", "BATCH_STATE_PENDING", "BATCH_STATE_RUNNING", "BATCH_STATE_SUCCEEDED", "BATCH_STATE_FAILED", "BATCH_STATE_CANCELLED", "BATCH_STATE_EXPIRED") {}
...
*/
export class BatchGenerateContentResponse extends S.Class<BatchGenerateContentResponse>("BatchGenerateContentResponse")({
  /**
* Output only. The output of the batch request.
*/
"output": S.optionalWith(GenerateContentBatchOutput, { nullable: true })
...
* network API call.
*/
export class BatchGenerateContentOperation extends S.Class<BatchGenerateContentOperation>("BatchGenerateContentOperation")({
...
* Veo response.
*/
export class PredictLongRunningGeneratedVideoResponse extends S.Class<PredictLongRunningGeneratedVideoResponse>("PredictLongRunningGeneratedVideoResponse")({
  /**
...
export class UpdateTunedModelParams extends S.Struct({
  "updateMask": S.optionalWith(S.String.pipe(S.pattern(new RegExp("^(\\s*[^,\\s.]+(\\s*[,.]\\s*[^,\\s.]+)*)?$"))), { nullable: true })
}) {}
...
*/
export class UploadToFileSearchStoreRequest extends S.Class<UploadToFileSearchStoreRequest>("UploadToFileSearchStoreRequest")({
  /**
...
*/
export class UploadToFileSearchStoreResponse extends S.Class<UploadToFileSearchStoreResponse>("UploadToFileSearchStoreResponse")({
  /**
...
* network API call.
*/
export class UploadToFileSearchStoreOperation extends S.Class<UploadToFileSearchStoreOperation>("UploadToFileSearchStoreOperation")({
...
*/
export class ConditionOperation extends S.Literal("OPERATOR_UNSPECIFIED", "LESS", "LESS_EQUAL", "EQUAL", "GREATER_EQUAL", "GREATER", "NOT_EQUAL", "INCLUDES", "EXCLUDES") {}
...
*/
export class GenerateAnswerRequestAnswerStyle extends S.Literal("ANSWER_STYLE_UNSPECIFIED", "ABSTRACTIVE", "EXTRACTIVE", "VERBOSE") {}
...
export class TaskType extends S.Literal("TASK_TYPE_UNSPECIFIED", "RETRIEVAL_QUERY", "RETRIEVAL_DOCUMENT", "SEMANTIC_SIMILARITY", "CLASSIFICATION", "CLUSTERING", "QUESTION_ANSWERING", "FACT_VERIFICATION", "CODE_RETRIEVAL_QUERY") {}
...
* The responses to the requests in the batch.
*/
export class InlinedEmbedContentResponses extends S.Class<InlinedEmbedContentResponses>("InlinedEmbedContentResponses")({
  /**
* Output only. The responses to the requests in the batch.
*/
...
*/
export class AsyncBatchEmbedContentRequest extends S.Class<AsyncBatchEmbedContentRequest>("AsyncBatchEmbedContentRequest")({
  /**
* Required. The batch to create.
*/
...
* Response for a `BatchGenerateContent` operation.
*/
export class AsyncBatchEmbedContentResponse extends S.Class<AsyncBatchEmbedContentResponse>("AsyncBatchEmbedContentResponse")({
  /**
* Output only. The output of the batch request.
*/
"output": S.optionalWith(EmbedContentBatchOutput, { nullable: true })
...
* network API call.
*/
export class AsyncBatchEmbedContentOperation extends S.Class<AsyncBatchEmbedContentOperation>("AsyncBatchEmbedContentOperation")({
...
export const make = (
  ...
  return {
    httpClient,
    "ListPermissionsByCorpus": (corpus, options) => HttpClientRequest.get(`/v1beta/corpora/${corpus}/permissions`).pipe(
    HttpClientRequest.setUrlParams({ "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any }),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(ListPermissionsResponse),
      orElse: unexpectedStatus
    }))
  ),
  "CreatePermissionByCorpus": (corpus, options) => HttpClientRequest.post(`/v1beta/corpora/${corpus}/permissions`).pipe(
  ...
  "ListFileSearchStores": (options) => HttpClientRequest.get(`/v1beta/fileSearchStores`).pipe(
    HttpClientRequest.setUrlParams({ "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any }),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "CreateFileSearchStore": (options) => HttpClientRequest.post(`/v1beta/fileSearchStores`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "StreamGenerateContent": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:streamGenerateContent`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "CountMessageTokens": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:countMessageTokens`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GetFile": (file) => HttpClientRequest.get(`/v1beta/files/${file}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(File),
      orElse: unexpectedStatus
    }))
  ),
  "DeleteFile": (file) => HttpClientRequest.del(`/v1beta/files/${file}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Empty),
      orElse: unexpectedStatus
    }))
  ),
  "ListTunedModels": (options) => HttpClientRequest.get(`/v1beta/tunedModels`).pipe(
    HttpClientRequest.setUrlParams({ "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any, "filter": options?.["filter"] as any }),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(ListTunedModelsResponse),
      orElse: unexpectedStatus
    }))
  ),
  "CreateTunedModel": (options) => HttpClientRequest.post(`/v1beta/tunedModels`).pipe(
  ...
  "ListOperationsByModel": (model, options) => HttpClientRequest.get(`/v1beta/models/${model}/operations`).pipe(
    HttpClientRequest.setUrlParams({ "filter": options?.["filter"] as any, "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any, "returnPartialSuccess": options?.["returnPartialSuccess"] as any }),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(ListOperationsResponse),
      orElse: unexpectedStatus
    }))
  ),
  "BatchGenerateContent": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:batchGenerateContent`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "DownloadFile": (file) => HttpClientRequest.get(`/v1beta/files/${file}:download`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(DownloadFileResponse),
      orElse: unexpectedStatus
    }))
  ),
  "PredictLongRunning": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:predictLongRunning`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GetPermission": (tunedModel, permission) => HttpClientRequest.get(`/v1beta/tunedModels/${tunedModel}/permissions/${permission}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Permission),
      orElse: unexpectedStatus
    }))
  ),
  "DeletePermission": (tunedModel, permission) => HttpClientRequest.del(`/v1beta/tunedModels/${tunedModel}/permissions/${permission}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Empty),
      orElse: unexpectedStatus
    }))
  ),
  "UpdatePermission": (tunedModel, permission, options) => HttpClientRequest.patch(`/v1beta/tunedModels/${tunedModel}/permissions/${permission}`).pipe(
  ...
  "CountTextTokens": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:countTextTokens`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GetTunedModel": (tunedModel) => HttpClientRequest.get(`/v1beta/tunedModels/${tunedModel}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(TunedModel),
      orElse: unexpectedStatus
    }))
  ),
  "DeleteTunedModel": (tunedModel) => HttpClientRequest.del(`/v1beta/tunedModels/${tunedModel}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Empty),
      orElse: unexpectedStatus
    }))
  ),
  "UpdateTunedModel": (tunedModel, options) => HttpClientRequest.patch(`/v1beta/tunedModels/${tunedModel}`).pipe(
    HttpClientRequest.setUrlParams({ "updateMask": options.params?.["updateMask"] as any }),
    HttpClientRequest.bodyUnsafeJson(options.payload),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(TunedModel),
  ...
  "BatchEmbedText": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:batchEmbedText`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GenerateMessage": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:generateMessage`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GetOperationByCorpusAndOperation": (corpus, operation) => HttpClientRequest.get(`/v1beta/corpora/${corpus}/operations/${operation}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Operation),
      orElse: unexpectedStatus
    }))
  ),
  "GetGeneratedFile": (generatedFile) => HttpClientRequest.get(`/v1beta/generatedFiles/${generatedFile}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(GeneratedFile),
      orElse: unexpectedStatus
    }))
  ),
  "ListCorpora": (options) => HttpClientRequest.get(`/v1beta/corpora`).pipe(
    HttpClientRequest.setUrlParams({ "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any }),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "CreateCorpus": (options) => HttpClientRequest.post(`/v1beta/corpora`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GetOperationByModelAndOperation": (model, operation) => HttpClientRequest.get(`/v1beta/models/${model}/operations/${operation}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Operation),
      orElse: unexpectedStatus
    }))
  ),
  "TransferOwnership": (tunedModel, options) => HttpClientRequest.post(`/v1beta/tunedModels/${tunedModel}:transferOwnership`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "ListOperationsBy": (options) => HttpClientRequest.get(`/v1beta/batches`).pipe(
    HttpClientRequest.setUrlParams({ "filter": options?.["filter"] as any, "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any, "returnPartialSuccess": options?.["returnPartialSuccess"] as any }),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(ListOperationsResponse),
      orElse: unexpectedStatus
  ...
  "GetOperation": (tunedModel, operation) => HttpClientRequest.get(`/v1beta/tunedModels/${tunedModel}/operations/${operation}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Operation),
      orElse: unexpectedStatus
    }))
  ),
  "UploadToFileSearchStore": (fileSearchStore, options) => HttpClientRequest.post(`/v1beta/fileSearchStores/${fileSearchStore}:uploadToFileSearchStore`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "CountTokens": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:countTokens`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "ListModels": (options) => HttpClientRequest.get(`/v1beta/models`).pipe(
    HttpClientRequest.setUrlParams({ "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any }),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GetModel": (model) => HttpClientRequest.get(`/v1beta/models/${model}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Model),
      orElse: unexpectedStatus
    }))
  ),
  "GenerateContentByDynamicId": (dynamicId, options) => HttpClientRequest.post(`/v1beta/dynamic/${dynamicId}:generateContent`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(GenerateContentResponse),
      orElse: unexpectedStatus
  ...
  "ListFiles": (options) => HttpClientRequest.get(`/v1beta/files`).pipe(
    HttpClientRequest.setUrlParams({ "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any }),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "CreateFile": (options) => HttpClientRequest.post(`/v1beta/files`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GetFileSearchStore": (fileSearchStore) => HttpClientRequest.get(`/v1beta/fileSearchStores/${fileSearchStore}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(FileSearchStore),
      orElse: unexpectedStatus
    }))
  ),
  "DeleteFileSearchStore": (fileSearchStore, options) => HttpClientRequest.del(`/v1beta/fileSearchStores/${fileSearchStore}`).pipe(
  ...
  "GenerateText": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:generateText`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GenerateContentByTunedModel": (tunedModel, options) => HttpClientRequest.post(`/v1beta/tunedModels/${tunedModel}:generateContent`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(GenerateContentResponse),
      orElse: unexpectedStatus
  ...
  "GetOperationByGeneratedFileAndOperation": (generatedFile, operation) => HttpClientRequest.get(`/v1beta/generatedFiles/${generatedFile}/operations/${operation}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Operation),
      orElse: unexpectedStatus
    }))
  ),
  "CancelOperation": (generateContentBatch) => HttpClientRequest.post(`/v1beta/batches/${generateContentBatch}:cancel`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Empty),
      orElse: unexpectedStatus
    }))
  ),
  "ImportFile": (fileSearchStore, options) => HttpClientRequest.post(`/v1beta/fileSearchStores/${fileSearchStore}:importFile`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GenerateAnswer": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:generateAnswer`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "BatchGenerateContentByTunedModel": (tunedModel, options) => HttpClientRequest.post(`/v1beta/tunedModels/${tunedModel}:batchGenerateContent`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(BatchGenerateContentOperation),
      orElse: unexpectedStatus
  ...
  "ListOperations": (tunedModel, options) => HttpClientRequest.get(`/v1beta/tunedModels/${tunedModel}/operations`).pipe(
    HttpClientRequest.setUrlParams({ "filter": options?.["filter"] as any, "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any, "returnPartialSuccess": options?.["returnPartialSuccess"] as any }),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(ListOperationsResponse),
      orElse: unexpectedStatus
  ...
  "EmbedContent": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:embedContent`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "AsyncBatchEmbedContent": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:asyncBatchEmbedContent`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GetCorpus": (corpus) => HttpClientRequest.get(`/v1beta/corpora/${corpus}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Corpus),
      orElse: unexpectedStatus
    }))
  ),
  "DeleteCorpus": (corpus, options) => HttpClientRequest.del(`/v1beta/corpora/${corpus}`).pipe(
    HttpClientRequest.setUrlParams({ "force": options?.["force"] as any }),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Empty),
      orElse: unexpectedStatus
  ...
  "GetDocument": (fileSearchStore, document) => HttpClientRequest.get(`/v1beta/fileSearchStores/${fileSearchStore}/documents/${document}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Document),
      orElse: unexpectedStatus
    }))
  ),
  "DeleteDocument": (fileSearchStore, document, options) => HttpClientRequest.del(`/v1beta/fileSearchStores/${fileSearchStore}/documents/${document}`).pipe(
    HttpClientRequest.setUrlParams({ "force": options?.["force"] as any }),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Empty),
      orElse: unexpectedStatus
  ...
  "EmbedText": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:embedText`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "AsyncBatchEmbedContentByTunedModel": (tunedModel, options) => HttpClientRequest.post(`/v1beta/tunedModels/${tunedModel}:asyncBatchEmbedContent`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(AsyncBatchEmbedContentOperation),
      orElse: unexpectedStatus
  ...
  "GetPermissionByCorpusAndPermission": (corpus, permission) => HttpClientRequest.get(`/v1beta/corpora/${corpus}/permissions/${permission}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Permission),
      orElse: unexpectedStatus
    }))
  ),
  "DeletePermissionByCorpusAndPermission": (corpus, permission) => HttpClientRequest.del(`/v1beta/corpora/${corpus}/permissions/${permission}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Empty),
      orElse: unexpectedStatus
    }))
  ),
  "UpdatePermissionByCorpusAndPermission": (corpus, permission, options) => HttpClientRequest.patch(`/v1beta/corpora/${corpus}/permissions/${permission}`).pipe(
    HttpClientRequest.setUrlParams({ "updateMask": options.params?.["updateMask"] as any }),
    HttpClientRequest.bodyUnsafeJson(options.payload),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Permission),
  ...
  "UpdateGenerateContentBatch": (generateContentBatch, options) => HttpClientRequest.patch(`/v1beta/batches/${generateContentBatch}:updateGenerateContentBatch`).pipe(
    HttpClientRequest.setUrlParams({ "updateMask": options.params?.["updateMask"] as any }),
    HttpClientRequest.bodyUnsafeJson(options.payload),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GetOperationByFileSearchStoresIdAndOperationsId": (fileSearchStoresId, operationsId) => HttpClientRequest.get(`/v1beta/fileSearchStores/${fileSearchStoresId}/upload/operations/${operationsId}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Operation),
      orElse: unexpectedStatus
    }))
  ),
  "UpdateEmbedContentBatch": (generateContentBatch, options) => HttpClientRequest.patch(`/v1beta/batches/${generateContentBatch}:updateEmbedContentBatch`).pipe(
    HttpClientRequest.setUrlParams({ "updateMask": options.params?.["updateMask"] as any }),
    HttpClientRequest.bodyUnsafeJson(options.payload),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "StreamGenerateContentByTunedModel": (tunedModel, options) => HttpClientRequest.post(`/v1beta/tunedModels/${tunedModel}:streamGenerateContent`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(GenerateContentResponse),
      orElse: unexpectedStatus
  ...
  "GenerateContent": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:generateContent`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(GenerateContentResponse),
      orElse: unexpectedStatus
  ...
  "BatchEmbedContents": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:batchEmbedContents`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "GenerateTextByTunedModel": (tunedModel, options) => HttpClientRequest.post(`/v1beta/tunedModels/${tunedModel}:generateText`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(GenerateTextResponse),
      orElse: unexpectedStatus
  ...
  "GetOperationByGenerateContentBatch": (generateContentBatch) => HttpClientRequest.get(`/v1beta/batches/${generateContentBatch}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Operation),
      orElse: unexpectedStatus
    }))
  ),
  "DeleteOperation": (generateContentBatch) => HttpClientRequest.del(`/v1beta/batches/${generateContentBatch}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Empty),
      orElse: unexpectedStatus
    }))
  ),
  "ListDocuments": (fileSearchStore, options) => HttpClientRequest.get(`/v1beta/fileSearchStores/${fileSearchStore}/documents`).pipe(
    HttpClientRequest.setUrlParams({ "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any }),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "StreamGenerateContentByDynamicId": (dynamicId, options) => HttpClientRequest.post(`/v1beta/dynamic/${dynamicId}:streamGenerateContent`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(GenerateContentResponse),
      orElse: unexpectedStatus
  ...
  "Predict": (model, options) => HttpClientRequest.post(`/v1beta/models/${model}:predict`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "ListCachedContents": (options) => HttpClientRequest.get(`/v1beta/cachedContents`).pipe(
    HttpClientRequest.setUrlParams({ "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any }),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "CreateCachedContent": (options) => HttpClientRequest.post(`/v1beta/cachedContents`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
  ...
  "ListPermissions": (tunedModel, options) => HttpClientRequest.get(`/v1beta/tunedModels/${tunedModel}/permissions`).pipe(
    HttpClientRequest.setUrlParams({ "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any }),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(ListPermissionsResponse),
      orElse: unexpectedStatus
  ...
  "CreatePermission": (tunedModel, options) => HttpClientRequest.post(`/v1beta/tunedModels/${tunedModel}/permissions`).pipe(
    HttpClientRequest.bodyUnsafeJson(options),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Permission),
      orElse: unexpectedStatus
  ...
  "GetCachedContent": (id) => HttpClientRequest.get(`/v1beta/cachedContents/${id}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(CachedContent),
      orElse: unexpectedStatus
    }))
  ),
  "DeleteCachedContent": (id) => HttpClientRequest.del(`/v1beta/cachedContents/${id}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Empty),
      orElse: unexpectedStatus
    }))
  ),
  "UpdateCachedContent": (id, options) => HttpClientRequest.patch(`/v1beta/cachedContents/${id}`).pipe(
    HttpClientRequest.setUrlParams({ "updateMask": options.params?.["updateMask"] as any }),
    HttpClientRequest.bodyUnsafeJson(options.payload),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(CachedContent),
  ...
  "GetOperationByFileSearchStoreAndOperation": (fileSearchStore, operation) => HttpClientRequest.get(`/v1beta/fileSearchStores/${fileSearchStore}/operations/${operation}`).pipe(
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(Operation),
      orElse: unexpectedStatus
    }))
  ),
  "ListGeneratedFiles": (options) => HttpClientRequest.get(`/v1beta/generatedFiles`).pipe(
    HttpClientRequest.setUrlParams({ "pageSize": options?.["pageSize"] as any, "pageToken": options?.["pageToken"] as any }),
    withResponse(HttpClientResponse.matchStatus({
...
*/
readonly "ListPermissionsByCorpus": (corpus: string, options?: typeof ListPermissionsByCorpusParams.Encoded | undefined) => Effect.Effect<typeof ListPermissionsResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Create a permission to a specific resource.
*/
readonly "CreatePermissionByCorpus": (corpus: string, options: typeof Permission.Encoded) => Effect.Effect<typeof Permission.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Lists all `FileSearchStores` owned by the user.
*/
readonly "ListFileSearchStores": (options?: typeof ListFileSearchStoresParams.Encoded | undefined) => Effect.Effect<typeof ListFileSearchStoresResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Creates an empty `FileSearchStore`.
*/
readonly "CreateFileSearchStore": (options: typeof FileSearchStore.Encoded) => Effect.Effect<typeof FileSearchStore.Type, HttpClientError.HttpClientError | ParseError>
  /**
...
*/
readonly "CountMessageTokens": (model: string, options: typeof CountMessageTokensRequest.Encoded) => Effect.Effect<typeof CountMessageTokensResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
...
* Deletes the `File`.
*/
readonly "DeleteFile": (file: string) => Effect.Effect<typeof Empty.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Lists created tuned models.
*/
readonly "ListTunedModels": (options?: typeof ListTunedModelsParams.Encoded | undefined) => Effect.Effect<typeof ListTunedModelsResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
...
*/
readonly "CreateTunedModel": (options: { readonly params?: typeof CreateTunedModelParams.Encoded | undefined; readonly payload: typeof TunedModel.Encoded }) => Effect.Effect<typeof CreateTunedModelOperation.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Lists operations that match the specified filter in the request. If the
* server doesn't support this method, it returns `UNIMPLEMENTED`.
*/
readonly "ListOperationsByModel": (model: string, options?: typeof ListOperationsByModelParams.Encoded | undefined) => Effect.Effect<typeof ListOperationsResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
...
* Download the `File`.
*/
readonly "DownloadFile": (file: string) => Effect.Effect<typeof DownloadFileResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Same as Predict but returns an LRO.
*/
readonly "PredictLongRunning": (model: string, options: typeof PredictLongRunningRequest.Encoded) => Effect.Effect<typeof PredictLongRunningOperation.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets information about a specific Permission.
*/
readonly "GetPermission": (tunedModel: string, permission: string) => Effect.Effect<typeof Permission.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Deletes the permission.
*/
readonly "DeletePermission": (tunedModel: string, permission: string) => Effect.Effect<typeof Empty.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Updates the permission.
*/
readonly "UpdatePermission": (tunedModel: string, permission: string, options: { readonly params: typeof UpdatePermissionParams.Encoded; readonly payload: typeof Permission.Encoded }) => Effect.Effect<typeof Permission.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Runs a model's tokenizer on a text and returns the token count.
*/
readonly "CountTextTokens": (model: string, options: typeof CountTextTokensRequest.Encoded) => Effect.Effect<typeof CountTextTokensResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets information about a specific TunedModel.
*/
readonly "GetTunedModel": (tunedModel: string) => Effect.Effect<typeof TunedModel.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Deletes a tuned model.
*/
readonly "DeleteTunedModel": (tunedModel: string) => Effect.Effect<typeof Empty.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Updates a tuned model.
*/
readonly "UpdateTunedModel": (tunedModel: string, options: { readonly params?: typeof UpdateTunedModelParams.Encoded | undefined; readonly payload: typeof TunedModel.Encoded }) => Effect.Effect<typeof TunedModel.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Generates multiple embeddings from the model given input text in a
* synchronous call.
*/
readonly "BatchEmbedText": (model: string, options: typeof BatchEmbedTextRequest.Encoded) => Effect.Effect<typeof BatchEmbedTextResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Generates a response from the model given an input `MessagePrompt`.
*/
readonly "GenerateMessage": (model: string, options: typeof GenerateMessageRequest.Encoded) => Effect.Effect<typeof GenerateMessageResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets the latest state of a long-running operation.  Clients can use this
* method to poll the operation result at intervals as recommended by the API
* service.
*/
readonly "GetOperationByCorpusAndOperation": (corpus: string, operation: string) => Effect.Effect<typeof Operation.Type, HttpClientError.HttpClientError | ParseError>
  /**
...
*/
readonly "GetGeneratedFile": (generatedFile: string) => Effect.Effect<typeof GeneratedFile.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Lists all `Corpora` owned by the user.
*/
readonly "ListCorpora": (options?: typeof ListCorporaParams.Encoded | undefined) => Effect.Effect<typeof ListCorporaResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Creates an empty `Corpus`.
*/
readonly "CreateCorpus": (options: typeof Corpus.Encoded) => Effect.Effect<typeof Corpus.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets the latest state of a long-running operation.  Clients can use this
* method to poll the operation result at intervals as recommended by the API
* service.
*/
readonly "GetOperationByModelAndOperation": (model: string, operation: string) => Effect.Effect<typeof Operation.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Transfers ownership of the tuned model.
* This is the only way to change ownership of the tuned model.
* The current owner will be downgraded to writer role.
*/
readonly "TransferOwnership": (tunedModel: string, options: typeof TransferOwnershipRequest.Encoded) => Effect.Effect<typeof TransferOwnershipResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Lists operations that match the specified filter in the request. If the
* server doesn't support this method, it returns `UNIMPLEMENTED`.
*/
readonly "ListOperationsBy": (options?: typeof ListOperationsByParams.Encoded | undefined) => Effect.Effect<typeof ListOperationsResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets the latest state of a long-running operation.  Clients can use this
* method to poll the operation result at intervals as recommended by the API
* service.
...
*/
readonly "UploadToFileSearchStore": (fileSearchStore: string, options: typeof UploadToFileSearchStoreRequest.Encoded) => Effect.Effect<typeof UploadToFileSearchStoreOperation.Type, HttpClientError.HttpClientError | ParseError>
  /**
...
*/
readonly "GenerateContentByDynamicId": (dynamicId: string, options: typeof GenerateContentRequest.Encoded) => Effect.Effect<typeof GenerateContentResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Lists the metadata for `File`s owned by the requesting project.
*/
readonly "ListFiles": (options?: typeof ListFilesParams.Encoded | undefined) => Effect.Effect<typeof ListFilesResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Creates a `File`.
*/
readonly "CreateFile": (options: typeof CreateFileRequest.Encoded) => Effect.Effect<typeof CreateFileResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets information about a specific `FileSearchStore`.
*/
readonly "GetFileSearchStore": (fileSearchStore: string) => Effect.Effect<typeof FileSearchStore.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Deletes a `FileSearchStore`.
*/
readonly "DeleteFileSearchStore": (fileSearchStore: string, options?: typeof DeleteFileSearchStoreParams.Encoded | undefined) => Effect.Effect<typeof Empty.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Generates a response from the model given an input message.
*/
readonly "GenerateText": (model: string, options: typeof GenerateTextRequest.Encoded) => Effect.Effect<typeof GenerateTextResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Generates a model response given an input `GenerateContentRequest`.
* Refer to the [text generation
* guide](https://ai.google.dev/gemini-api/docs/text-generation) for detailed
...
* guide](https://ai.google.dev/gemini-api/docs/model-tuning) for details.
*/
readonly "GenerateContentByTunedModel": (tunedModel: string, options: typeof GenerateContentRequest.Encoded) => Effect.Effect<typeof GenerateContentResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets the latest state of a long-running operation.  Clients can use this
* method to poll the operation result at intervals as recommended by the API
* service.
*/
readonly "GetOperationByGeneratedFileAndOperation": (generatedFile: string, operation: string) => Effect.Effect<typeof Operation.Type, HttpClientError.HttpClientError | ParseError>
  /**
...
*/
readonly "CancelOperation": (generateContentBatch: string) => Effect.Effect<typeof Empty.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Imports a `File` from File Service to a `FileSearchStore`.
*/
readonly "ImportFile": (fileSearchStore: string, options: typeof ImportFileRequest.Encoded) => Effect.Effect<typeof ImportFileOperation.Type, HttpClientError.HttpClientError | ParseError>
  /**
...
* Enqueues a batch of `GenerateContent` requests for batch processing.
*/
readonly "BatchGenerateContentByTunedModel": (tunedModel: string, options: typeof BatchGenerateContentRequest.Encoded) => Effect.Effect<typeof BatchGenerateContentOperation.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Lists operations that match the specified filter in the request. If the
* server doesn't support this method, it returns `UNIMPLEMENTED`.
*/
readonly "ListOperations": (tunedModel: string, options?: typeof ListOperationsParams.Encoded | undefined) => Effect.Effect<typeof ListOperationsResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
...
*/
readonly "AsyncBatchEmbedContent": (model: string, options: typeof AsyncBatchEmbedContentRequest.Encoded) => Effect.Effect<typeof AsyncBatchEmbedContentOperation.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets information about a specific `Corpus`.
*/
readonly "GetCorpus": (corpus: string) => Effect.Effect<typeof Corpus.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Deletes a `Corpus`.
*/
readonly "DeleteCorpus": (corpus: string, options?: typeof DeleteCorpusParams.Encoded | undefined) => Effect.Effect<typeof Empty.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets information about a specific `Document`.
*/
readonly "GetDocument": (fileSearchStore: string, document: string) => Effect.Effect<typeof Document.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Deletes a `Document`.
*/
readonly "DeleteDocument": (fileSearchStore: string, document: string, options?: typeof DeleteDocumentParams.Encoded | undefined) => Effect.Effect<typeof Empty.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Generates an embedding from the model given an input message.
*/
readonly "EmbedText": (model: string, options: typeof EmbedTextRequest.Encoded) => Effect.Effect<typeof EmbedTextResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Enqueues a batch of `EmbedContent` requests for batch processing.
* We have a `BatchEmbedContents` handler in `GenerativeService`, but it was
* synchronized. So we name this one to be `Async` to avoid confusion.
*/
readonly "AsyncBatchEmbedContentByTunedModel": (tunedModel: string, options: typeof AsyncBatchEmbedContentRequest.Encoded) => Effect.Effect<typeof AsyncBatchEmbedContentOperation.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets information about a specific Permission.
*/
readonly "GetPermissionByCorpusAndPermission": (corpus: string, permission: string) => Effect.Effect<typeof Permission.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Deletes the permission.
*/
readonly "DeletePermissionByCorpusAndPermission": (corpus: string, permission: string) => Effect.Effect<typeof Empty.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Updates the permission.
*/
readonly "UpdatePermissionByCorpusAndPermission": (corpus: string, permission: string, options: { readonly params: typeof UpdatePermissionByCorpusAndPermissionParams.Encoded; readonly payload: typeof Permission.Encoded }) => Effect.Effect<typeof Permission.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Updates a batch of GenerateContent requests for batch processing.
*/
readonly "UpdateGenerateContentBatch": (generateContentBatch: string, options: { readonly params?: typeof UpdateGenerateContentBatchParams.Encoded | undefined; readonly payload: typeof GenerateContentBatch.Encoded }) => Effect.Effect<typeof GenerateContentBatch.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets the latest state of a long-running operation.  Clients can use this
* method to poll the operation result at intervals as recommended by the API
* service.
*/
readonly "GetOperationByFileSearchStoresIdAndOperationsId": (fileSearchStoresId: string, operationsId: string) => Effect.Effect<typeof Operation.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Updates a batch of EmbedContent requests for batch processing.
*/
readonly "UpdateEmbedContentBatch": (generateContentBatch: string, options: { readonly params?: typeof UpdateEmbedContentBatchParams.Encoded | undefined; readonly payload: typeof EmbedContentBatch.Encoded }) => Effect.Effect<typeof EmbedContentBatch.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Generates a [streamed
* response](https://ai.google.dev/gemini-api/docs/text-generation?lang=python#generate-a-text-stream)
* from the model given an input `GenerateContentRequest`.
*/
readonly "StreamGenerateContentByTunedModel": (tunedModel: string, options: typeof GenerateContentRequest.Encoded) => Effect.Effect<typeof GenerateContentResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Generates a model response given an input `GenerateContentRequest`.
* Refer to the [text generation
* guide](https://ai.google.dev/gemini-api/docs/text-generation) for detailed
...
* Generates a response from the model given an input message.
*/
readonly "GenerateTextByTunedModel": (tunedModel: string, options: typeof GenerateTextRequest.Encoded) => Effect.Effect<typeof GenerateTextResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets the latest state of a long-running operation.  Clients can use this
* method to poll the operation result at intervals as recommended by the API
* service.
*/
readonly "GetOperationByGenerateContentBatch": (generateContentBatch: string) => Effect.Effect<typeof Operation.Type, HttpClientError.HttpClientError | ParseError>
  /**
...
*/
readonly "DeleteOperation": (generateContentBatch: string) => Effect.Effect<typeof Empty.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Lists all `Document`s in a `Corpus`.
*/
readonly "ListDocuments": (fileSearchStore: string, options?: typeof ListDocumentsParams.Encoded | undefined) => Effect.Effect<typeof ListDocumentsResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Generates a [streamed
* response](https://ai.google.dev/gemini-api/docs/text-generation?lang=python#generate-a-text-stream)
* from the model given an input `GenerateContentRequest`.
*/
readonly "StreamGenerateContentByDynamicId": (dynamicId: string, options: typeof GenerateContentRequest.Encoded) => Effect.Effect<typeof GenerateContentResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Performs a prediction request.
*/
readonly "Predict": (model: string, options: typeof PredictRequest.Encoded) => Effect.Effect<typeof PredictResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
...
* Lists permissions for the specific resource.
*/
readonly "ListPermissions": (tunedModel: string, options?: typeof ListPermissionsParams.Encoded | undefined) => Effect.Effect<typeof ListPermissionsResponse.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Create a permission to a specific resource.
*/
readonly "CreatePermission": (tunedModel: string, options: typeof Permission.Encoded) => Effect.Effect<typeof Permission.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Reads CachedContent resource.
*/
readonly "GetCachedContent": (id: string) => Effect.Effect<typeof CachedContent.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Deletes CachedContent resource.
*/
readonly "DeleteCachedContent": (id: string) => Effect.Effect<typeof Empty.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Updates CachedContent resource (only expiration is updatable).
*/
readonly "UpdateCachedContent": (id: string, options: { readonly params?: typeof UpdateCachedContentParams.Encoded | undefined; readonly payload: typeof CachedContent.Encoded }) => Effect.Effect<typeof CachedContent.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Gets the latest state of a long-running operation.  Clients can use this
* method to poll the operation result at intervals as recommended by the API
* service.
*/
readonly "GetOperationByFileSearchStoreAndOperation": (fileSearchStore: string, operation: string) => Effect.Effect<typeof Operation.Type, HttpClientError.HttpClientError | ParseError>
  /**
* Lists the generated files owned by the requesting project.
*/
readonly "ListGeneratedFiles": (options?: typeof ListGeneratedFilesParams.Encoded | undefined) => Effect.Effect<typeof ListGeneratedFilesResponse.Type, HttpClientError.HttpClientError | ParseError>
}
