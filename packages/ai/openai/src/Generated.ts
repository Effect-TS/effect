...
export class ChatCompletionRequestDeveloperMessage extends S.Struct({
  ...
  "content": S.Union(
     ...
     */
    S.NonEmptyArray(ChatCompletionRequestMessageContentPartText)
  ),
  /**
   * The role of the messages author, in this case `developer`.
   */
...
export class ChatCompletionRequestSystemMessage extends S.Struct({
  ...
  "content": S.Union(
     ...
     */
    S.NonEmptyArray(ChatCompletionRequestSystemMessageContentPart)
  ),
  /**
   * The role of the messages author, in this case `system`.
   */
...
export class ChatCompletionRequestUserMessage extends S.Struct({
  ...
  "content": S.Union(
     ...
     */
    S.NonEmptyArray(ChatCompletionRequestUserMessageContentPart)
  ),
  /**
   * The role of the messages author, in this case `user`.
   */
...
export class ChatCompletionRequestAssistantMessage extends S.Struct({
  ...
  "content": S.optionalWith(
    S.Union(
       ...
       */
      S.NonEmptyArray(ChatCompletionRequestAssistantMessageContentPart)
    ),
    { nullable: true }
  ),
  /**
...
export class ChatCompletionRequestToolMessage extends S.Struct({
  ...
  "content": S.Union(
     ...
     */
    S.NonEmptyArray(ChatCompletionRequestToolMessageContentPart)
  ),
  /**
 ...
 */
export class EvalCustomDataSourceConfig extends S.Struct({
  /**
   * The type of data source. Always `custom`.
   */
 ...
 */
export class EvalStoredCompletionsDataSourceConfig extends S.Struct({
  /**
   * The type of data source. Always `stored_completions`.
   */
 ...
 */
export class InputTextContent extends S.Struct({
  /**
   * The type of the input item. Always `input_text`.
   */
 ...
 * interactions.
 */
export class EvalItem extends S.Struct({
  /**
   * The role of the message input. One of `user`, `assistant`, `system`, or
   * `developer`.
   */
 ...
 * in the evaluation.
 */
export class EvalLabelModelGrader extends S.Struct({
  /**
   * The object type, which is always `label_model`.
   */
 ...
 */
export class EvalStringCheckGrader extends S.Struct({
  /**
   * The object type, which is always `string_check`.
   */
 ...
 */
export class EvalTextSimilarityGrader extends S.Struct({
  /**
   * The type of grader.
   */
 ...
 */
export class EvalPythonGrader extends S.Struct({
  /**
   * The object type, which is always `python`.
   */
 ...
 */
export class EvalScoreModelGrader extends S.Struct({
  /**
   * The object type, which is always `score_model`.
   */
 ...
 */
export class Eval extends S.Struct({
  /**
   * The object type.
   */
 ...
 * - What data is required when creating a run
 */
export class CreateEvalCustomDataSourceConfig extends S.Struct({
  /**
   * The type of data source. Always `custom`.
   */
 ...
 * This is usually metadata like `usecase=chatbot` or `prompt-version=v2`, etc.
 */
export class CreateEvalLogsDataSourceConfig extends S.Struct({
  /**
   * The type of data source. Always `logs`.
   */
  "type": CreateEvalLogsDataSourceConfigType.pipe(S.propertySignature, S.withConstructorDefault(() => "logs" as const)),
  /**
 ...
 * in the evaluation.
 */
export class CreateEvalLabelModelGrader extends S.Struct({
  /**
   * The object type, which is always `label_model`.
   */
...
export class EvalJsonlFileContentSource extends S.Struct({
  /**
   * The type of jsonl source. Always `file_content`.
   */
...
export class EvalJsonlFileIdSource extends S.Struct({
  /**
   * The type of jsonl source. Always `file_id`.
   */
 ...
 */
export class CreateEvalJsonlRunDataSource extends S.Struct({
  /**
   * The type of data source. Always `jsonl`.
   */
  "type": CreateEvalJsonlRunDataSourceType.pipe(S.propertySignature, S.withConstructorDefault(() => "jsonl" as const)),
 ...
 */
export class InputImageContent extends S.Struct({
  /**
   * The type of the input item. Always `input_image`.
   */
 ...
 */
export class InputFileContent extends S.Struct({
  /**
   * The type of the input item. Always `input_file`.
   */
 ...
 */
export class EvalStoredCompletionsSource extends S.Struct({
  /**
   * The type of source. Always `stored_completions`.
   */
 ...
 */
export class CreateEvalCompletionsRunDataSource extends S.Struct({
  /**
   * The type of run data source. Always `completions`.
   */
 ...
 */
export class EvalResponsesSource extends S.Struct({
  /**
   * The type of run data source. Always `responses`.
   */
 ...
 */
export class CreateEvalResponsesRunDataSource extends S.Struct({
  /**
   * The type of run data source. Always `completions`.
   */
 ...
 */
export class EvalApiError extends S.Struct({
  /**
   * The error code.
   */
  "code": S.String,
 ...
 */
export class EvalRun extends S.Struct({
  /**
   * The type of the object. Always "eval.run".
   */
 ...
 */
export class EvalRunOutputItem extends S.Struct({
  /**
   * The type of the object. Always "eval.run.output_item".
   */
 ...
 */
export class Certificate extends S.Struct({
  /**
   * The object type.
   *
   * - If creating, updating, or getting a specific certificate, the object type is `certificate`.
...
export class ToggleCertificatesRequest extends S.Class<ToggleCertificatesRequest>("ToggleCertificatesRequest")({
  "certificate_ids": S.Array(S.String).pipe(S.minItems(1), S.maxItems(10))
}) {}
 ...
 */
export class FileCitationBody extends S.Struct({
  /**
   * The type of the file citation. Always `file_citation`.
   */
 ...
 */
export class UrlCitationBody extends S.Struct({
  /**
   * The type of the URL citation. Always `url_citation`.
   */
 ...
 * A text output from the model.
 */
export class OutputTextContent extends S.Struct({
  /**
   * The type of the output text. Always `output_text`.
   */
 ...
 */
export class RefusalContent extends S.Struct({
  /**
   * The type of the refusal. Always `refusal`.
   */
 ...
 * A pending safety check for the computer call.
 */
export class ComputerCallSafetyCheckParam extends S.Struct({
  /**
   * The ID of the pending safety check.
   */
  "id": S.String,
 ...
 */
export class ComputerCallOutputItemParam extends S.Struct({
  "id": S.optionalWith(S.String, { nullable: true }),
  /**
 ...
 */
export class FunctionCallOutputItemParam extends S.Struct({
  "id": S.optionalWith(S.String, { nullable: true }),
  /**
   * The unique ID of the function tool call generated by the model.
   */
 ...
 */
export class ItemReferenceParam extends S.Struct({
...
export class RankingOptions extends S.Struct({
  /**
   * The ranker to use for the file search.
   */
...
export class ApproximateLocation extends S.Struct({
  /**
   * The type of location approximation. Always `approximate`.
   */
 ...
 */
export class WebSearchPreviewTool extends S.Struct({
  /**
   * The type of the web search tool. One of `web_search_preview` or `web_search_preview_2025_03_11`.
   */
 ...
 */
export class ComputerUsePreviewTool extends S.Struct({
  /**
   * The type of the computer use tool. Always `computer_use_preview`.
   */
