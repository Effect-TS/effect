 ...
 */
export const bracketOnError = <E, A, S1, E1, R1, A1, S2, R2, E2, A2>(
  use: (a: A) => Effect<S1, R1, E1, A1>,
  release: (a: A, e: Exit<E1, A1>) => Effect<S2, R2, E2, any>
) => <S, R>(acquire: Effect<S, R, E, A>) => bracketOnError_(acquire, use, release)

/**
 * Executes the release effect only if there was an error.
 */
export const bracketOnError_ = <S, R, E, A, S1, E1, R1, A1, S2, R2, E2, A2>(
