...
export const add: {
  ...
  >(
    ...
    Req | Public,
    Private,
    R | R2 | Serializable.SerializableWithExit.Context<Req>
  >
  <
    State,
    Public extends Schema.TaggedRequest.All,
  ...
  >(
    ...
    schema: Schema.Schema<Req, I, ReqR> & { readonly _tag: Req["_tag"] },
    handler: Procedure.Handler<Req, Types.NoInfer<State>, Types.NoInfer<Public> | Types.NoInfer<Private>, R2>
  ): SerializableProcedureList<State, Req | Public, Private, R | R2 | Serializable.SerializableWithExit.Context<Req>>
} = dual(
  3,
  <
    State,
...
export const addPrivate: {
  ...
  >(
    ...
    schema: Schema.Schema<Req, I, ReqR> & { readonly _tag: Req["_tag"] },
    handler: Procedure.Handler<Req, Types.NoInfer<State>, Types.NoInfer<Public> | Types.NoInfer<Private>, R2>
  ): SerializableProcedureList<State, Public, Private | Req, R | R2 | Serializable.SerializableWithExit.Context<Req>>
} = dual(
  3,
  <
    State,
