# Example Suggestions: `@effect/sql-sqlite-bun/SqliteMigrator`

- **Package:** `@effect/sql-sqlite-bun`
- **Source:** `packages/sql/sqlite-bun/src/SqliteMigrator.ts`
...
| --------------------------------------------- | ---: | ------------------ | --------------- |
| `@effect/sql-sqlite-bun/SqliteMigrator.layer` |   84 | `root-declaration` | **recommended** |
| `@effect/sql-sqlite-bun/SqliteMigrator.run`   |   28 | `root-declaration` | **recommended** |

## Recommended

### `@effect/sql-sqlite-bun/SqliteMigrator.layer`

- **Source:** `packages/sql/sqlite-bun/src/SqliteMigrator.ts:84`
...
- **Import guidance:** Start from `import { SqliteMigrator } from "@effect/sql-sqlite-bun"` and use `SqliteMigrator.layer`.
...
### `@effect/sql-sqlite-bun/SqliteMigrator.run`

- **Source:** `packages/sql/sqlite-bun/src/SqliteMigrator.ts:28`
- **Kind / category:** `root-declaration` / `constructors`
- **Priority:** **recommended**
...
- **Import guidance:** Start from `import { SqliteMigrator } from "@effect/sql-sqlite-bun"` and use `SqliteMigrator.run`.
