# Example Suggestions: `@effect/platform-node/NodeStdio`

- **Package:** `@effect/platform-node`
- **Source:** `packages/platform-node/src/NodeStdio.ts`
...
| --------------------------------------- | ---: | ------------------ | --------------- |
| `@effect/platform-node/NodeStdio.layer` |   22 | `root-declaration` | **recommended** |

## Recommended

### `@effect/platform-node/NodeStdio.layer`

- **Source:** `packages/platform-node/src/NodeStdio.ts:22`
...
- **Import guidance:** Start from `import { NodeStdio } from "@effect/platform-node"` and use `NodeStdio.layer`.
