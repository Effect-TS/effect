...
Add platform-neutral IP, internet, and Unix socket address values under `effect/unstable/net/Net`, with strict parsing, canonical formatting, checked and unsafe construction, classification, equality, hashing, and matching `effect/Schema` codecs.
