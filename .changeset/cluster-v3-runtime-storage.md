...
Fix cluster shutdown and routing, registration, reply handling, shard-lock recovery, and resource cleanup. Fix workflow suspension, deferred races, self-completion deadlocks, finalization ordering, and zero-duration clocks. Interrupted RPC stream writes now release waiting consumers.
