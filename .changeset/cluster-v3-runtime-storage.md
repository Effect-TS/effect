...
Fix cluster shutdown routing and durable workflow abandonment. Persisted requests abandoned during shutdown interrupt for replay without running durable workflow finalizers or waking the parent. Volatile requests and abandoned acknowledgements expose `EntityNotAssignedToRunner`; discard sends settle during shutdown. Limit internal interruption classification to active entity, shard, and client teardown.
